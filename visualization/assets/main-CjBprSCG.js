var tl=Object.defineProperty;var el=(r,t,e)=>t in r?tl(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var D=(r,t,e)=>el(r,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function e(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=e(s);fetch(s.href,i)}})();class nl{constructor(){D(this,"currentHandler",null);D(this,"handlers",new Map);D(this,"basePath");this.basePath="/visualization/",window.addEventListener("popstate",()=>this.handleRoute())}register(t,e){this.handlers.set(t,e)}navigate(t){const e=t==="/"?this.basePath:`${this.basePath}${t.slice(1)}.html`;window.location.href=e}handleRoute(){const t=window.location.pathname;let e="/";t.includes("aliasing-sine.html")?e="/aliasing-sine":t.includes("aliasing-audio.html")?e="/aliasing-audio":t.includes("z-transform.html")?e="/z-transform":t.includes("pole-zero.html")&&(e="/pole-zero"),this.currentHandler&&this.currentHandler.unmount();const n=this.handlers.get(e)||this.handlers.get("/");n&&(this.currentHandler=n(),this.currentHandler.mount())}start(){this.handleRoute()}}class il{constructor(t,e){D(this,"container");D(this,"router");this.container=t,this.router=e}mount(){this.container.innerHTML=`
...
#define LOW_PRECISION`),t}function Uf(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===xo?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===ul?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===en&&(t="SHADOWMAP_TYPE_VSM"),t}function Ff(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case ui:case di:t="ENVMAP_TYPE_CUBE";break;case ws:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Of(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case di:t="ENVMAP_MODE_REFRACTION";break}return t}function Bf(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case vo:t="ENVMAP_BLENDING_MULTIPLY";break;case Ol:t="ENVMAP_BLENDING_MIX";break;case Bl:t="ENVMAP_BLENDING_ADD";break}return t}function zf(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function kf(r,t,e,n){const s=r.getContext(),i=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Uf(e),c=Ff(e),h=Of(e),u=Bf(e),f=zf(e),d=wf(e),g=Cf(i),_=s.createProgram();let m,p,S=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      background-size:100% 4px;`;const n=document.createElement("div");return n.style.cssText="position:absolute;top:5px;left:9px;font-size:7px;font-weight:700;letter-spacing:.1em;color:var(--color-text-dim);text-transform:uppercase;z-index:2;pointer-events:none;",n.textContent=t,e.appendChild(n),e}makeCanvas2D(t,e,n){const s=window.devicePixelRatio||1,i=document.createElement("canvas");return i.width=e*s,i.height=n*s,i.style.width=e+"px",i.style.height=n+"px",i.style.display="block",i.getContext("2d").scale(s,s),t.appendChild(i),i}resizeCanvas2D(t,e,n){const s=window.devicePixelRatio||1,i=Math.max(120,Math.floor(e)),a=Math.max(80,Math.floor(n));t.width=i*s,t.height=a*s,t.style.width=`${i}px`,t.style.height=`${a}px`;const o=t.getContext("2d");o.setTransform(1,0,0,1,0,0),o.scale(s,s)}resizeCanvasWebGL(t,e,n){const s=Math.min(window.devicePixelRatio||1,2),i=Math.max(120,Math.floor(e)),a=Math.max(80,Math.floor(n));t.width=i*s,t.height=a*s,t.style.width=`${i}px`,t.style.height=`${a}px`}resizeLayout(){const t=Math.max(760,this.container.clientWidth-2),e=8,n=Math.max(320,Math.floor(t*.44)),s=Math.max(360,t-n-e);if(this.resizeCanvas2D(this.planeCanvas,n,370),this.resizeCanvasWebGL(this.surfaceCanvas,s,370),this.resizeCanvas2D(this.responseCanvas,t,120),this.resizeCanvas2D(this.spectrumCanvas,t,130),this.threeRenderer&&this.threeCamera){const i=Math.min(window.devicePixelRatio||1,2),a=this.surfaceCanvas.width/i,o=this.surfaceCanvas.height/i;this.threeRenderer.setSize(a,o,!1),this.threeRenderer.setPixelRatio(i),this.threeCamera.aspect=a/o,this.threeCamera.updateProjectionMatrix()}}makeCanvasWebGL(t,e,n){const s=Math.min(window.devicePixelRatio||1,2),i=document.createElement("canvas");return i.width=e*s,i.height=n*s,i.style.width=e+"px",i.style.height=n+"px",i.style.display="block",i.style.cursor="grab",t.appendChild(i),i}setupPlaneInteraction(){const t=this.planeCanvas,e=i=>{const a=t.getBoundingClientRect(),o=window.devicePixelRatio||1,l=t.width/o,c=t.height/o,h=Math.min(l,c)*.35;return{re:(i.clientX-a.left-l/2)/h,im:-(i.clientY-a.top-c/2-8)/h}},n=(i,a,o=.13)=>{let l=-1,c=o;return a.forEach((h,u)=>{const f=qt.abs(qt.sub(h,i));f<c&&(c=f,l=u)}),l},s=(i,a)=>{const o=i[a];return i.filter((l,c)=>c!==a&&!(Math.abs(l.re-o.re)<.02&&Math.abs(Math.abs(l.im)-Math.abs(o.im))<.02))};t.oncontextmenu=i=>i.preventDefault(),t.onmousedown=i=>{i.preventDefault();const a=e(i),o=n(a,this.poles),l=n(a,this.zeros);if(o>=0){const c=this.poles[o],h=Math.abs(c.im)>.04?this.poles.findIndex((u,f)=>f!==o&&Math.abs(u.re-c.re)<.03&&Math.abs(u.im+c.im)<.03):-1;this.dragging={type:"pole",idx:o,conjIdx:h,origIm:c.im};return}if(l>=0){const c=this.zeros[l],h=Math.abs(c.im)>.04?this.zeros.findIndex((u,f)=>f!==l&&Math.abs(u.re-c.re)<.03&&Math.abs(u.im+c.im)<.03):-1;this.dragging={type:"zero",idx:l,conjIdx:h,origIm:c.im};return}i.button===2?(this.poles.push({re:a.re,im:a.im}),Math.abs(a.im)>.04&&this.poles.push({re:a.re,im:-a.im})):(this.zeros.push({re:a.re,im:a.im}),Math.abs(a.im)>.04&&this.zeros.push({re:a.re,im:-a.im})),this.onFilterChanged()},t.ondblclick=i=>{const a=e(i),o=.16,l=this.poles.findIndex(h=>qt.abs(qt.sub(h,a))<o);if(l>=0){this.poles=s(this.poles,l),this.onFilterChanged();return}const c=this.zeros.findIndex(h=>qt.abs(qt.sub(h,a))<o);c>=0&&(this.zeros=s(this.zeros,c),this.onFilterChanged())},t.onmousemove=i=>{if(!this.dragging)return;const a=e(i),{type:o,idx:l,conjIdx:c,origIm:h}=this.dragging,u=o==="pole"?this.poles:this.zeros;if(c>=0&&c<u.length){const g=(Math.sign(h)||1)>0?Math.max(a.im,.04):Math.min(a.im,-.04);u[l]={re:a.re,im:g},u[c]={re:a.re,im:-g}}else u[l]={re:a.re,im:a.im};this.onFilterChanged()},t.onmouseup=()=>{this.dragging=null},t.onmouseleave=()=>{this.dragging=null}}onFilterChanged(){this.useThreeJS&&this.updateThreeSurface(),this.updateFilterInfo(),this.updateLiveFilter()}updateFilterInfo(){const t=this.poles.every(s=>qt.abs(s)<1),e=this.computeMag({re:1,im:0}),n=this.computeMag({re:-1,im:0});this.filterInfoEl.innerHTML=`
