var Al=Object.defineProperty;var Cl=(a,t,e)=>t in a?Al(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var x=(a,t,e)=>Cl(a,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function e(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=e(i);fetch(i.href,s)}})();class Pl{constructor(){x(this,"currentHandler",null);x(this,"handlers",new Map);x(this,"basePath");this.basePath="/visualization/",window.addEventListener("popstate",()=>this.handleRoute())}register(t,e){this.handlers.set(t,e)}navigate(t){const e=t==="/"?this.basePath:`${this.basePath}${t.slice(1)}.html`;window.location.href=e}handleRoute(){const t=window.location.pathname;let e="/";t.includes("aliasing-sine.html")?e="/aliasing-sine":t.includes("aliasing-audio.html")?e="/aliasing-audio":t.includes("z-transform.html")?e="/z-transform":t.includes("pole-zero.html")?e="/pole-zero":t.includes("convolution.html")?e="/convolution":t.includes("dft-demo.html")?e="/dft-demo":t.includes("difference-equations.html")?e="/difference-equations":t.includes("filter-design.html")&&(e="/filter-design"),this.currentHandler&&this.currentHandler.unmount();const n=this.handlers.get(e)||this.handlers.get("/");n&&(this.currentHandler=n(),this.currentHandler.mount())}start(){this.handleRoute()}}class Rl{constructor(t,e){x(this,"container");x(this,"router");this.container=t,this.router=e}mount(){this.container.innerHTML=`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,Nt={alphahash_fragment:ih,alphahash_pars_fragment:sh,alphamap_fragment:ah,alphamap_pars_fragment:rh,alphatest_fragment:oh,alphatest_pars_fragment:lh,aomap_fragment:ch,aomap_pars_fragment:hh,batching_pars_vertex:uh,batching_vertex:dh,begin_vertex:fh,beginnormal_vertex:ph,bsdfs:mh,iridescence_fragment:gh,bumpmap_pars_fragment:_h,clipping_planes_fragment:xh,clipping_planes_pars_fragment:vh,clipping_planes_pars_vertex:yh,clipping_planes_vertex:Sh,color_fragment:Mh,color_pars_fragment:bh,color_pars_vertex:Eh,color_vertex:wh,common:Th,cube_uv_reflection_fragment:Ah,defaultnormal_vertex:Ch,displacementmap_pars_vertex:Ph,displacementmap_vertex:Rh,emissivemap_fragment:Dh,emissivemap_pars_fragment:Lh,colorspace_fragment:Ih,colorspace_pars_fragment:Nh,envmap_fragment:Uh,envmap_common_pars_fragment:Fh,envmap_pars_fragment:Bh,envmap_pars_vertex:Oh,envmap_physical_pars_fragment:Kh,envmap_vertex:kh,fog_vertex:zh,fog_pars_vertex:Hh,fog_fragment:Gh,fog_pars_fragment:Vh,gradientmap_pars_fragment:Wh,lightmap_pars_fragment:qh,lights_lambert_fragment:Xh,lights_lambert_pars_fragment:Yh,lights_pars_begin:$h,lights_toon_fragment:jh,lights_toon_pars_fragment:Zh,lights_phong_fragment:Jh,lights_phong_pars_fragment:Qh,lights_physical_fragment:tu,lights_physical_pars_fragment:eu,lights_fragment_begin:nu,lights_fragment_maps:iu,lights_fragment_end:su,logdepthbuf_fragment:au,logdepthbuf_pars_fragment:ru,logdepthbuf_pars_vertex:ou,logdepthbuf_vertex:lu,map_fragment:cu,map_pars_fragment:hu,map_particle_fragment:uu,map_particle_pars_fragment:du,metalnessmap_fragment:fu,metalnessmap_pars_fragment:pu,morphinstance_vertex:mu,morphcolor_vertex:gu,morphnormal_vertex:_u,morphtarget_pars_vertex:xu,morphtarget_vertex:vu,normal_fragment_begin:yu,normal_fragment_maps:Su,normal_pars_fragment:Mu,normal_pars_vertex:bu,normal_vertex:Eu,normalmap_pars_fragment:wu,clearcoat_normal_fragment_begin:Tu,clearcoat_normal_fragment_maps:Au,clearcoat_pars_fragment:Cu,iridescence_pars_fragment:Pu,opaque_fragment:Ru,packing:Du,premultiplied_alpha_fragment:Lu,project_vertex:Iu,dithering_fragment:Nu,dithering_pars_fragment:Uu,roughnessmap_fragment:Fu,roughnessmap_pars_fragment:Bu,shadowmap_pars_fragment:Ou,shadowmap_pars_vertex:ku,shadowmap_vertex:zu,shadowmask_pars_fragment:Hu,skinbase_vertex:Gu,skinning_pars_vertex:Vu,skinning_vertex:Wu,skinnormal_vertex:qu,specularmap_fragment:Xu,specularmap_pars_fragment:Yu,tonemapping_fragment:$u,tonemapping_pars_fragment:Ku,transmission_fragment:ju,transmission_pars_fragment:Zu,uv_pars_fragment:Ju,uv_pars_vertex:Qu,uv_vertex:td,worldpos_vertex:ed,background_vert:nd,background_frag:id,backgroundCube_vert:sd,backgroundCube_frag:ad,cube_vert:rd,cube_frag:od,depth_vert:ld,depth_frag:cd,distanceRGBA_vert:hd,distanceRGBA_frag:ud,equirect_vert:dd,equirect_frag:fd,linedashed_vert:pd,linedashed_frag:md,meshbasic_vert:gd,meshbasic_frag:_d,meshlambert_vert:xd,meshlambert_frag:vd,meshmatcap_vert:yd,meshmatcap_frag:Sd,meshnormal_vert:Md,meshnormal_frag:bd,meshphong_vert:Ed,meshphong_frag:wd,meshphysical_vert:Td,meshphysical_frag:Ad,meshtoon_vert:Cd,meshtoon_frag:Pd,points_vert:Rd,points_frag:Dd,shadow_vert:Ld,shadow_frag:Id,sprite_vert:Nd,sprite_frag:Ud},st={common:{diffuse:{value:new Ht(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new Ut},alphaMap:{value:null},alphaMapTransform:{value:new Ut},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new Ut}},envmap:{envMap:{value:null},envMapRotation:{value:new Ut},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new Ut}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new Ut}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new Ut},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new Ut},normalScale:{value:new Dt(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new Ut},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new Ut}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new Ut}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new Ut}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new Ht(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new Ht(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new Ut},alphaTest:{value:0},uvTransform:{value:new Ut}},sprite:{diffuse:{value:new Ht(16777215)},opacity:{value:1},center:{value:new Dt(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new Ut},alphaMap:{value:null},alphaMapTransform:{value:new Ut},alphaTest:{value:0}}},Ke={basic:{uniforms:ye([st.common,st.specularmap,st.envmap,st.aomap,st.lightmap,st.fog]),vertexShader:Nt.meshbasic_vert,fragmentShader:Nt.meshbasic_frag},lambert:{uniforms:ye([st.common,st.specularmap,st.envmap,st.aomap,st.lightmap,st.emissivemap,st.bumpmap,st.normalmap,st.displacementmap,st.fog,st.lights,{emissive:{value:new Ht(0)}}]),vertexShader:Nt.meshlambert_vert,fragmentShader:Nt.meshlambert_frag},phong:{uniforms:ye([st.common,st.specularmap,st.envmap,st.aomap,st.lightmap,st.emissivemap,st.bumpmap,st.normalmap,st.displacementmap,st.fog,st.lights,{emissive:{value:new Ht(0)},specular:{value:new Ht(1118481)},shininess:{value:30}}]),vertexShader:Nt.meshphong_vert,fragmentShader:Nt.meshphong_frag},standard:{uniforms:ye([st.common,st.envmap,st.aomap,st.lightmap,st.emissivemap,st.bumpmap,st.normalmap,st.displacementmap,st.roughnessmap,st.metalnessmap,st.fog,st.lights,{emissive:{value:new Ht(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Nt.meshphysical_vert,fragmentShader:Nt.meshphysical_frag},toon:{uniforms:ye([st.common,st.aomap,st.lightmap,st.emissivemap,st.bumpmap,st.normalmap,st.displacementmap,st.gradientmap,st.fog,st.lights,{emissive:{value:new Ht(0)}}]),vertexShader:Nt.meshtoon_vert,fragmentShader:Nt.meshtoon_frag},matcap:{uniforms:ye([st.common,st.bumpmap,st.normalmap,st.displacementmap,st.fog,{matcap:{value:null}}]),vertexShader:Nt.meshmatcap_vert,fragmentShader:Nt.meshmatcap_frag},points:{uniforms:ye([st.points,st.fog]),vertexShader:Nt.points_vert,fragmentShader:Nt.points_frag},dashed:{uniforms:ye([st.common,st.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Nt.linedashed_vert,fragmentShader:Nt.linedashed_frag},depth:{uniforms:ye([st.common,st.displacementmap]),vertexShader:Nt.depth_vert,fragmentShader:Nt.depth_frag},normal:{uniforms:ye([st.common,st.bumpmap,st.normalmap,st.displacementmap,{opacity:{value:1}}]),vertexShader:Nt.meshnormal_vert,fragmentShader:Nt.meshnormal_frag},sprite:{uniforms:ye([st.sprite,st.fog]),vertexShader:Nt.sprite_vert,fragmentShader:Nt.sprite_frag},background:{uniforms:{uvTransform:{value:new Ut},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Nt.background_vert,fragmentShader:Nt.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new Ut}},vertexShader:Nt.backgroundCube_vert,fragmentShader:Nt.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Nt.cube_vert,fragmentShader:Nt.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Nt.equirect_vert,fragmentShader:Nt.equirect_frag},distanceRGBA:{uniforms:ye([st.common,st.displacementmap,{referencePosition:{value:new U},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Nt.distanceRGBA_vert,fragmentShader:Nt.distanceRGBA_frag},shadow:{uniforms:ye([st.lights,st.fog,{color:{value:new Ht(0)},opacity:{value:1}}]),vertexShader:Nt.shadow_vert,fragmentShader:Nt.shadow_frag}};Ke.physical={uniforms:ye([Ke.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new Ut},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new Ut},clearcoatNormalScale:{value:new Dt(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new Ut},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new Ut},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new Ut},sheen:{value:0},sheenColor:{value:new Ht(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new Ut},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new Ut},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new Ut},transmissionSamplerSize:{value:new Dt},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new Ut},attenuationDistance:{value:0},attenuationColor:{value:new Ht(0)},specularColor:{value:new Ht(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new Ut},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new Ut},anisotropyVector:{value:new Dt},anisotropyMap:{value:null},anisotropyMapTransform:{value:new Ut}}]),vertexShader:Nt.meshphysical_vert,fragmentShader:Nt.meshphysical_frag};const ds={r:0,b:0,g:0},Ln=new dn,Fd=new oe;function Bd(a,t,e,n,i,s,r){const o=new Ht(0);let l=s===!0?0:1,c,h,u=null,d=0,f=null;function g(M){let v=M.isScene===!0?M.background:null;return v&&v.isTexture&&(v=(M.backgroundBlurriness>0?e:t).get(v)),v}function _(M){let v=!1;const S=g(M);S===null?m(o,l):S&&S.isColor&&(m(S,1),v=!0);const R=a.xr.getEnvironmentBlendMode();R==="additive"?n.buffers.color.setClear(0,0,0,1,r):R==="alpha-blend"&&n.buffers.color.setClear(0,0,0,0,r),(a.autoClear||v)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),a.clear(a.autoClearColor,a.autoClearDepth,a.autoClearStencil))}function p(M,v){const S=g(v);S&&(S.isCubeTexture||S.mapping===Bs)?(h===void 0&&(h=new Ie(new Wi(1,1,1),new wn({name:"BackgroundCubeMaterial",uniforms:wi(Ke.backgroundCube.uniforms),vertexShader:Ke.backgroundCube.vertexShader,fragmentShader:Ke.backgroundCube.fragmentShader,side:Te,depthTest:!1,depthWrite:!1,fog:!1})),h.geometry.deleteAttribute("normal"),h.geometry.deleteAttribute("uv"),h.onBeforeRender=function(R,A,C){this.matrixWorld.copyPosition(C.matrixWorld)},Object.defineProperty(h.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),i.update(h)),Ln.copy(v.backgroundRotation),Ln.x*=-1,Ln.y*=-1,Ln.z*=-1,S.isCubeTexture&&S.isRenderTargetTexture===!1&&(Ln.y*=-1,Ln.z*=-1),h.material.uniforms.envMap.value=S,h.material.uniforms.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,h.material.uniforms.backgroundBlurriness.value=v.backgroundBlurriness,h.material.uniforms.backgroundIntensity.value=v.backgroundIntensity,h.material.uniforms.backgroundRotation.value.setFromMatrix4(Fd.makeRotationFromEuler(Ln)),h.material.toneMapped=Xt.getTransfer(S.colorSpace)!==Zt,(u!==S||d!==S.version||f!==a.toneMapping)&&(h.material.needsUpdate=!0,u=S,d=S.version,f=a.toneMapping),h.layers.enableAll(),M.unshift(h,h.geometry,h.material,0,0,null)):S&&S.isTexture&&(c===void 0&&(c=new Ie(new zs(2,2),new wn({name:"BackgroundMaterial",uniforms:wi(Ke.background.uniforms),vertexShader:Ke.background.vertexShader,fragmentShader:Ke.background.fragmentShader,side:hn,depthTest:!1,depthWrite:!1,fog:!1})),c.geometry.deleteAttribute("normal"),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),i.update(c)),c.material.uniforms.t2D.value=S,c.material.uniforms.backgroundIntensity.value=v.backgroundIntensity,c.material.toneMapped=Xt.getTransfer(S.colorSpace)!==Zt,S.matrixAutoUpdate===!0&&S.updateMatrix(),c.material.uniforms.uvTransform.value.copy(S.matrix),(u!==S||d!==S.version||f!==a.toneMapping)&&(c.material.needsUpdate=!0,u=S,d=S.version,f=a.toneMapping),c.layers.enableAll(),M.unshift(c,c.geometry,c.material,0,0,null))}function m(M,v){M.getRGB(ds,ul(a)),n.buffers.color.setClear(ds.r,ds.g,ds.b,v,r)}return{getClearColor:function(){return o},setClearColor:function(M,v=1){o.set(M),l=v,m(o,l)},getClearAlpha:function(){return l},setClearAlpha:function(M){l=M,m(o,l)},render:_,addToRenderList:p}}function Od(a,t){const e=a.getParameter(a.MAX_VERTEX_ATTRIBS),n={},i=d(null);let s=i,r=!1;function o(E,D,H,z,X){let K=!1;const W=u(z,H,D);s!==W&&(s=W,c(s.object)),K=f(E,z,H,X),K&&g(E,z,H,X),X!==null&&t.update(X,a.ELEMENT_ARRAY_BUFFER),(K||r)&&(r=!1,S(E,D,H,z),X!==null&&a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,t.get(X).buffer))}function l(){return a.createVertexArray()}function c(E){return a.bindVertexArray(E)}function h(E){return a.deleteVertexArray(E)}function u(E,D,H){const z=H.wireframe===!0;let X=n[E.id];X===void 0&&(X={},n[E.id]=X);let K=X[D.id];K===void 0&&(K={},X[D.id]=K);let W=K[z];return W===void 0&&(W=d(l()),K[z]=W),W}function d(E){const D=[],H=[],z=[];for(let X=0;X<e;X++)D[X]=0,H[X]=0,z[X]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:D,enabledAttributes:H,attributeDivisors:z,object:E,attributes:{},index:null}}function f(E,D,H,z){const X=s.attributes,K=D.attributes;let W=0;const Z=H.getAttributes();for(const G in Z)if(Z[G].location>=0){const ut=X[G];let _t=K[G];if(_t===void 0&&(G==="instanceMatrix"&&E.instanceMatrix&&(_t=E.instanceMatrix),G==="instanceColor"&&E.instanceColor&&(_t=E.instanceColor)),ut===void 0||ut.attribute!==_t||_t&&ut.data!==_t.data)return!0;W++}return s.attributesNum!==W||s.index!==z}function g(E,D,H,z){const X={},K=D.attributes;let W=0;const Z=H.getAttributes();for(const G in Z)if(Z[G].location>=0){let ut=K[G];ut===void 0&&(G==="instanceMatrix"&&E.instanceMatrix&&(ut=E.instanceMatrix),G==="instanceColor"&&E.instanceColor&&(ut=E.instanceColor));const _t={};_t.attribute=ut,ut&&ut.data&&(_t.data=ut.data),X[G]=_t,W++}s.attributes=X,s.attributesNum=W,s.index=z}function _(){const E=s.newAttributes;for(let D=0,H=E.length;D<H;D++)E[D]=0}function p(E){m(E,0)}function m(E,D){const H=s.newAttributes,z=s.enabledAttributes,X=s.attributeDivisors;H[E]=1,z[E]===0&&(a.enableVertexAttribArray(E),z[E]=1),X[E]!==D&&(a.vertexAttribDivisor(E,D),X[E]=D)}function M(){const E=s.newAttributes,D=s.enabledAttributes;for(let H=0,z=D.length;H<z;H++)D[H]!==E[H]&&(a.disableVertexAttribArray(H),D[H]=0)}function v(E,D,H,z,X,K,W){W===!0?a.vertexAttribIPointer(E,D,H,X,K):a.vertexAttribPointer(E,D,H,z,X,K)}function S(E,D,H,z){_();const X=z.attributes,K=H.getAttributes(),W=D.defaultAttributeValues;for(const Z in K){const G=K[Z];if(G.location>=0){let ot=X[Z];if(ot===void 0&&(Z==="instanceMatrix"&&E.instanceMatrix&&(ot=E.instanceMatrix),Z==="instanceColor"&&E.instanceColor&&(ot=E.instanceColor)),ot!==void 0){const ut=ot.normalized,_t=ot.itemSize,Ot=t.get(ot);if(Ot===void 0)continue;const $t=Ot.buffer,V=Ot.type,Q=Ot.bytesPerElement,mt=V===a.INT||V===a.UNSIGNED_INT||ot.gpuType===fr;if(ot.isInterleavedBufferAttribute){const ct=ot.data,Et=ct.stride,Pt=ot.offset;if(ct.isInstancedInterleavedBuffer){for(let Bt=0;Bt<G.locationSize;Bt++)m(G.location+Bt,ct.meshPerAttribute);E.isInstancedMesh!==!0&&z._maxInstanceCount===void 0&&(z._maxInstanceCount=ct.meshPerAttribute*ct.count)}else for(let Bt=0;Bt<G.locationSize;Bt++)p(G.location+Bt);a.bindBuffer(a.ARRAY_BUFFER,$t);for(let Bt=0;Bt<G.locationSize;Bt++)v(G.location+Bt,_t/G.locationSize,V,ut,Et*Q,(Pt+_t/G.locationSize*Bt)*Q,mt)}else{if(ot.isInstancedBufferAttribute){for(let ct=0;ct<G.locationSize;ct++)m(G.location+ct,ot.meshPerAttribute);E.isInstancedMesh!==!0&&z._maxInstanceCount===void 0&&(z._maxInstanceCount=ot.meshPerAttribute*ot.count)}else for(let ct=0;ct<G.locationSize;ct++)p(G.location+ct);a.bindBuffer(a.ARRAY_BUFFER,$t);for(let ct=0;ct<G.locationSize;ct++)v(G.location+ct,_t/G.locationSize,V,ut,_t*Q,_t/G.locationSize*ct*Q,mt)}}else if(W!==void 0){const ut=W[Z];if(ut!==void 0)switch(ut.length){case 2:a.vertexAttrib2fv(G.location,ut);break;case 3:a.vertexAttrib3fv(G.location,ut);break;case 4:a.vertexAttrib4fv(G.location,ut);break;default:a.vertexAttrib1fv(G.location,ut)}}}}M()}function R(){B();for(const E in n){const D=n[E];for(const H in D){const z=D[H];for(const X in z)h(z[X].object),delete z[X];delete D[H]}delete n[E]}}function A(E){if(n[E.id]===void 0)return;const D=n[E.id];for(const H in D){const z=D[H];for(const X in z)h(z[X].object),delete z[X];delete D[H]}delete n[E.id]}function C(E){for(const D in n){const H=n[D];if(H[E.id]===void 0)continue;const z=H[E.id];for(const X in z)h(z[X].object),delete z[X];delete H[E.id]}}function B(){w(),r=!0,s!==i&&(s=i,c(s.object))}function w(){i.geometry=null,i.program=null,i.wireframe=!1}return{setup:o,reset:B,resetDefaultState:w,dispose:R,releaseStatesOfGeometry:A,releaseStatesOfProgram:C,initAttributes:_,enableAttribute:p,disableUnusedAttributes:M}}function kd(a,t,e){let n;function i(c){n=c}function s(c,h){a.drawArrays(n,c,h),e.update(h,n,1)}function r(c,h,u){u!==0&&(a.drawArraysInstanced(n,c,h,u),e.update(h,n,u))}function o(c,h,u){if(u===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(n,c,0,h,0,u);let f=0;for(let g=0;g<u;g++)f+=h[g];e.update(f,n,1)}function l(c,h,u,d){if(u===0)return;const f=t.get("WEBGL_multi_draw");if(f===null)for(let g=0;g<c.length;g++)r(c[g],h[g],d[g]);else{f.multiDrawArraysInstancedWEBGL(n,c,0,h,0,d,0,u);let g=0;for(let _=0;_<u;_++)g+=h[_];for(let _=0;_<d.length;_++)e.update(g,n,d[_])}}this.setMode=i,this.render=s,this.renderInstances=r,this.renderMultiDraw=o,this.renderMultiDrawInstances=l}function zd(a,t,e,n){let i;function s(){if(i!==void 0)return i;if(t.has("EXT_texture_filter_anisotropic")===!0){const A=t.get("EXT_texture_filter_anisotropic");i=a.getParameter(A.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else i=0;return i}function r(A){return!(A!==Xe&&n.convert(A)!==a.getParameter(a.IMPLEMENTATION_COLOR_READ_FORMAT))}function o(A){const C=A===zi&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(A!==un&&n.convert(A)!==a.getParameter(a.IMPLEMENTATION_COLOR_READ_TYPE)&&A!==on&&!C)}function l(A){if(A==="highp"){if(a.getShaderPrecisionFormat(a.VERTEX_SHADER,a.HIGH_FLOAT).precision>0&&a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.HIGH_FLOAT).precision>0)return"highp";A="mediump"}return A==="mediump"&&a.getShaderPrecisionFormat(a.VERTEX_SHADER,a.MEDIUM_FLOAT).precision>0&&a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let c=e.precision!==void 0?e.precision:"highp";const h=l(c);h!==c&&(console.warn("THREE.WebGLRenderer:",c,"not supported, using",h,"instead."),c=h);const u=e.logarithmicDepthBuffer===!0,d=a.getParameter(a.MAX_TEXTURE_IMAGE_UNITS),f=a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS),g=a.getParameter(a.MAX_TEXTURE_SIZE),_=a.getParameter(a.MAX_CUBE_MAP_TEXTURE_SIZE),p=a.getParameter(a.MAX_VERTEX_ATTRIBS),m=a.getParameter(a.MAX_VERTEX_UNIFORM_VECTORS),M=a.getParameter(a.MAX_VARYING_VECTORS),v=a.getParameter(a.MAX_FRAGMENT_UNIFORM_VECTORS),S=f>0,R=a.getParameter(a.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:s,getMaxPrecision:l,textureFormatReadable:r,textureTypeReadable:o,precision:c,logarithmicDepthBuffer:u,maxTextures:d,maxVertexTextures:f,maxTextureSize:g,maxCubemapSize:_,maxAttributes:p,maxVertexUniforms:m,maxVaryings:M,maxFragmentUniforms:v,vertexTextures:S,maxSamples:R}}function Hd(a){const t=this;let e=null,n=0,i=!1,s=!1;const r=new Sn,o=new Ut,l={value:null,needsUpdate:!1};this.uniform=l,this.numPlanes=0,this.numIntersection=0,this.init=function(u,d){const f=u.length!==0||d||n!==0||i;return i=d,n=u.length,f},this.beginShadows=function(){s=!0,h(null)},this.endShadows=function(){s=!1},this.setGlobalState=function(u,d){e=h(u,d,0)},this.setState=function(u,d,f){const g=u.clippingPlanes,_=u.clipIntersection,p=u.clipShadows,m=a.get(u);if(!i||g===null||g.length===0||s&&!p)s?h(null):c();else{const M=s?0:n,v=M*4;let S=m.clippingState||null;l.value=S,S=h(g,d,v,f);for(let R=0;R!==v;++R)S[R]=e[R];m.clippingState=S,this.numIntersection=_?this.numPlanes:0,this.numPlanes+=M}};function c(){l.value!==e&&(l.value=e,l.needsUpdate=n>0),t.numPlanes=n,t.numIntersection=0}function h(u,d,f,g){const _=u!==null?u.length:0;let p=null;if(_!==0){if(p=l.value,g!==!0||p===null){const m=f+_*4,M=d.matrixWorldInverse;o.getNormalMatrix(M),(p===null||p.length<m)&&(p=new Float32Array(m));for(let v=0,S=f;v!==_;++v,S+=4)r.copy(u[v]).applyMatrix4(M,o),r.normal.toArray(p,S),p[S+3]=r.constant}l.value=p,l.needsUpdate=!0}return t.numPlanes=_,t.numIntersection=0,p}}function Gd(a){let t=new WeakMap;function e(r,o){return o===La?r.mapping=Si:o===Ia&&(r.mapping=Mi),r}function n(r){if(r&&r.isTexture){const o=r.mapping;if(o===La||o===Ia)if(t.has(r)){const l=t.get(r).texture;return e(l,r.mapping)}else{const l=r.image;if(l&&l.height>0){const c=new Qc(l.height);return c.fromEquirectangularTexture(a,r),t.set(r,c),r.addEventListener("dispose",i),e(c.texture,r.mapping)}else return null}}return r}function i(r){const o=r.target;o.removeEventListener("dispose",i);const l=t.get(o);l!==void 0&&(t.delete(o),l.dispose())}function s(){t=new WeakMap}return{get:n,dispose:s}}class Vd extends dl{constructor(t=-1,e=1,n=1,i=-1,s=.1,r=2e3){super(),this.isOrthographicCamera=!0,this.type="OrthographicCamera",this.zoom=1,this.view=null,this.left=t,this.right=e,this.top=n,this.bottom=i,this.near=s,this.far=r,this.updateProjectionMatrix()}copy(t,e){return super.copy(t,e),this.left=t.left,this.right=t.right,this.top=t.top,this.bottom=t.bottom,this.near=t.near,this.far=t.far,this.zoom=t.zoom,this.view=t.view===null?null:Object.assign({},t.view),this}setViewOffset(t,e,n,i,s,r){this.view===null&&(this.view={enabled:!0,fullWidth:1,fullHeight:1,offsetX:0,offsetY:0,width:1,height:1}),this.view.enabled=!0,this.view.fullWidth=t,this.view.fullHeight=e,this.view.offsetX=n,this.view.offsetY=i,this.view.width=s,this.view.height=r,this.updateProjectionMatrix()}clearViewOffset(){this.view!==null&&(this.view.enabled=!1),this.updateProjectionMatrix()}updateProjectionMatrix(){const t=(this.right-this.left)/(2*this.zoom),e=(this.top-this.bottom)/(2*this.zoom),n=(this.right+this.left)/2,i=(this.top+this.bottom)/2;let s=n-t,r=n+t,o=i+e,l=i-e;if(this.view!==null&&this.view.enabled){const c=(this.right-this.left)/this.view.fullWidth/this.zoom,h=(this.top-this.bottom)/this.view.fullHeight/this.zoom;s+=c*this.view.offsetX,r=s+c*this.view.width,o-=h*this.view.offsetY,l=o-h*this.view.height}this.projectionMatrix.makeOrthographic(s,r,o,l,this.near,this.far,this.coordinateSystem),this.projectionMatrixInverse.copy(this.projectionMatrix).invert()}toJSON(t){const e=super.toJSON(t);return e.object.zoom=this.zoom,e.object.left=this.left,e.object.right=this.right,e.object.top=this.top,e.object.bottom=this.bottom,e.object.near=this.near,e.object.far=this.far,this.view!==null&&(e.object.view=Object.assign({},this.view)),e}}const mi=4,ao=[.125,.215,.35,.446,.526,.582],Fn=20,fa=new Vd,ro=new Ht;let pa=null,ma=0,ga=0,_a=!1;const Nn=(1+Math.sqrt(5))/2,di=1/Nn,oo=[new U(-Nn,di,0),new U(Nn,di,0),new U(-di,0,Nn),new U(di,0,Nn),new U(0,Nn,-di),new U(0,Nn,di),new U(-1,1,-1),new U(1,1,-1),new U(-1,1,1),new U(1,1,1)];class lo{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(t,e=0,n=.1,i=100){pa=this._renderer.getRenderTarget(),ma=this._renderer.getActiveCubeFace(),ga=this._renderer.getActiveMipmapLevel(),_a=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(256);const s=this._allocateTargets();return s.depthBuffer=!0,this._sceneToCubeUV(t,n,i,s),e>0&&this._blur(s,0,0,e),this._applyPMREM(s),this._cleanup(s),s}fromEquirectangular(t,e=null){return this._fromTexture(t,e)}fromCubemap(t,e=null){return this._fromTexture(t,e)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=uo(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=ho(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodPlanes.length;t++)this._lodPlanes[t].dispose()}_cleanup(t){this._renderer.setRenderTarget(pa,ma,ga),this._renderer.xr.enabled=_a,t.scissorTest=!1,fs(t,0,0,t.width,t.height)}_fromTexture(t,e){t.mapping===Si||t.mapping===Mi?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),pa=this._renderer.getRenderTarget(),ma=this._renderer.getActiveCubeFace(),ga=this._renderer.getActiveMipmapLevel(),_a=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const n=e||this._allocateTargets();return this._textureToCubeUV(t,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),e=4*this._cubeSize,n={magFilter:We,minFilter:We,generateMipmaps:!1,type:zi,format:Xe,colorSpace:Tn,depthBuffer:!1},i=co(t,e,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==e){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=co(t,e,n);const{_lodMax:s}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=Wd(s)),this._blurMaterial=qd(s,t,e)}return i}_compileMaterial(t){const e=new Ie(this._lodPlanes[0],t);this._renderer.compile(e,fa)}_sceneToCubeUV(t,e,n,i){const o=new Fe(90,1,e,n),l=[1,-1,1,1,1,1],c=[1,1,1,-1,-1,-1],h=this._renderer,u=h.autoClear,d=h.toneMapping;h.getClearColor(ro),h.toneMapping=En,h.autoClear=!1;const f=new pi({name:"PMREM.Background",side:Te,depthWrite:!1,depthTest:!1}),g=new Ie(new Wi,f);let _=!1;const p=t.background;p?p.isColor&&(f.color.copy(p),t.background=null,_=!0):(f.color.copy(ro),_=!0);for(let m=0;m<6;m++){const M=m%3;M===0?(o.up.set(0,l[m],0),o.lookAt(c[m],0,0)):M===1?(o.up.set(0,0,l[m]),o.lookAt(0,c[m],0)):(o.up.set(0,l[m],0),o.lookAt(0,0,c[m]));const v=this._cubeSize;fs(i,M*v,m>2?v:0,v,v),h.setRenderTarget(i),_&&h.render(g,o),h.render(t,o)}g.geometry.dispose(),g.material.dispose(),h.toneMapping=d,h.autoClear=u,t.background=p}_textureToCubeUV(t,e){const n=this._renderer,i=t.mapping===Si||t.mapping===Mi;i?(this._cubemapMaterial===null&&(this._cubemapMaterial=uo()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=ho());const s=i?this._cubemapMaterial:this._equirectMaterial,r=new Ie(this._lodPlanes[0],s),o=s.uniforms;o.envMap.value=t;const l=this._cubeSize;fs(e,0,0,3*l,2*l),n.setRenderTarget(e),n.render(r,fa)}_applyPMREM(t){const e=this._renderer,n=e.autoClear;e.autoClear=!1;const i=this._lodPlanes.length;for(let s=1;s<i;s++){const r=Math.sqrt(this._sigmas[s]*this._sigmas[s]-this._sigmas[s-1]*this._sigmas[s-1]),o=oo[(i-s-1)%oo.length];this._blur(t,s-1,s,r,o)}e.autoClear=n}_blur(t,e,n,i,s){const r=this._pingPongRenderTarget;this._halfBlur(t,r,e,n,i,"latitudinal",s),this._halfBlur(r,t,n,n,i,"longitudinal",s)}_halfBlur(t,e,n,i,s,r,o){const l=this._renderer,c=this._blurMaterial;r!=="latitudinal"&&r!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const h=3,u=new Ie(this._lodPlanes[i],c),d=c.uniforms,f=this._sizeLods[n]-1,g=isFinite(s)?Math.PI/(2*f):2*Math.PI/(2*Fn-1),_=s/g,p=isFinite(s)?1+Math.floor(h*_):Fn;p>Fn&&console.warn(`sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${Fn}`);const m=[];let M=0;for(let C=0;C<Fn;++C){const B=C/_,w=Math.exp(-B*B/2);m.push(w),C===0?M+=w:C<p&&(M+=2*w)}for(let C=0;C<m.length;C++)m[C]=m[C]/M;d.envMap.value=t.texture,d.samples.value=p,d.weights.value=m,d.latitudinal.value=r==="latitudinal",o&&(d.poleAxis.value=o);const{_lodMax:v}=this;d.dTheta.value=g,d.mipInt.value=v-n;const S=this._sizeLods[i],R=3*S*(i>v-mi?i-v+mi:0),A=4*(this._cubeSize-S);fs(e,R,A,3*S,2*S),l.setRenderTarget(e),l.render(u,fa)}}function Wd(a){const t=[],e=[],n=[];let i=a;const s=a-mi+1+ao.length;for(let r=0;r<s;r++){const o=Math.pow(2,i);e.push(o);let l=1/o;r>a-mi?l=ao[r-a+mi-1]:r===0&&(l=0),n.push(l);const c=1/(o-2),h=-c,u=1+c,d=[h,h,u,h,u,u,h,h,u,u,h,u],f=6,g=6,_=3,p=2,m=1,M=new Float32Array(_*g*f),v=new Float32Array(p*g*f),S=new Float32Array(m*g*f);for(let A=0;A<f;A++){const C=A%3*2/3-1,B=A>2?0:-1,w=[C,B,0,C+2/3,B,0,C+2/3,B+1,0,C,B,0,C+2/3,B+1,0,C,B+1,0];M.set(w,_*g*A),v.set(d,p*g*A);const E=[A,A,A,A,A,A];S.set(E,m*g*A)}const R=new Me;R.setAttribute("position",new _e(M,_)),R.setAttribute("uv",new _e(v,p)),R.setAttribute("faceIndex",new _e(S,m)),t.push(R),i>mi&&i--}return{lodPlanes:t,sizeLods:e,sigmas:n}}function co(a,t,e){const n=new Vn(a,t,e);return n.texture.mapping=Bs,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n}function fs(a,t,e,n,i){a.viewport.set(t,e,n,i),a.scissor.set(t,e,n,i)}function qd(a,t,e){const n=new Float32Array(Fn),i=new U(0,1,0);return new wn({name:"SphericalGaussianBlur",defines:{n:Fn,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${a}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Sr(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function ho(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sr(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function uo(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sr(),fragmentShader:`
	...
	`}function Xd(a){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===La||l===Ia,h=l===Si||l===Mi;if(c||h){let u=t.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return e===null&&(e=new lo(a)),u=c?e.fromEquirectangular(o,u):e.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),u.texture;if(u!==void 0)return u.texture;{const f=o.image;return c&&f&&f.height>0||h&&f&&i(f)?(e===null&&(e=new lo(a)),u=c?e.fromEquirectangular(o):e.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),o.addEventListener("dispose",s),u.texture):null}}}return o}function i(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function r(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:r}}function Yd(a){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=a.getExtension("WEBGL_depth_texture")||a.getExtension("MOZ_WEBGL_depth_texture")||a.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=a.getExtension("EXT_texture_filter_anisotropic")||a.getExtension("MOZ_EXT_texture_filter_anisotropic")||a.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=a.getExtension("WEBGL_compressed_texture_s3tc")||a.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||a.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=a.getExtension("WEBGL_compressed_texture_pvrtc")||a.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=a.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&Bi("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function $d(a,t,e,n){const i={},s=new WeakMap;function r(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)t.remove(_[p])}d.removeEventListener("dispose",r),delete i[d.id];const f=s.get(d);f&&(t.remove(f),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(u,d){return i[d.id]===!0||(d.addEventListener("dispose",r),i[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const g in d)t.update(d[g],a.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)t.update(_[p],a.ARRAY_BUFFER)}}function c(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const M=f.array;_=f.version;for(let v=0,S=M.length;v<S;v+=3){const R=M[v+0],A=M[v+1],C=M[v+2];d.push(R,A,A,C,C,R)}}else if(g!==void 0){const M=g.array;_=g.version;for(let v=0,S=M.length/3-1;v<S;v+=3){const R=v+0,A=v+1,C=v+2;d.push(R,A,A,C,C,R)}}else return;const p=new(sl(d)?hl:cl)(d,1);p.version=_;const m=s.get(u);m&&t.remove(m),s.set(u,p)}function h(u){const d=s.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return s.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function Kd(a,t,e){let n;function i(d){n=d}let s,r;function o(d){s=d.type,r=d.bytesPerElement}function l(d,f){a.drawElements(n,f,s,d*r),e.update(f,n,1)}function c(d,f,g){g!==0&&(a.drawElementsInstanced(n,f,s,d*r,g),e.update(f,n,g))}function h(d,f,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,s,d,0,g);let p=0;for(let m=0;m<g;m++)p+=f[m];e.update(p,n,1)}function u(d,f,g,_){if(g===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<d.length;m++)c(d[m]/r,f[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,s,d,0,_,0,g);let m=0;for(let M=0;M<g;M++)m+=f[M];for(let M=0;M<_.length;M++)e.update(m,n,_[M])}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function jd(a){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,r,o){switch(e.calls++,r){case a.TRIANGLES:e.triangles+=o*(s/3);break;case a.LINES:e.lines+=o*(s/2);break;case a.LINE_STRIP:e.lines+=o*(s-1);break;case a.LINE_LOOP:e.lines+=o*s;break;case a.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",r);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function Zd(a,t,e){const n=new WeakMap,i=new pe;function s(r,o,l){const c=r.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let E=function(){B.dispose(),n.delete(o),o.removeEventListener("dispose",E)};var f=E;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],M=o.morphAttributes.normal||[],v=o.morphAttributes.color||[];let S=0;g===!0&&(S=1),_===!0&&(S=2),p===!0&&(S=3);let R=o.attributes.position.count*S,A=1;R>t.maxTextureSize&&(A=Math.ceil(R/t.maxTextureSize),R=t.maxTextureSize);const C=new Float32Array(R*A*4*u),B=new rl(C,R,A,u);B.type=on,B.needsUpdate=!0;const w=S*4;for(let D=0;D<u;D++){const H=m[D],z=M[D],X=v[D],K=R*A*4*D;for(let W=0;W<H.count;W++){const Z=W*w;g===!0&&(i.fromBufferAttribute(H,W),C[K+Z+0]=i.x,C[K+Z+1]=i.y,C[K+Z+2]=i.z,C[K+Z+3]=0),_===!0&&(i.fromBufferAttribute(z,W),C[K+Z+4]=i.x,C[K+Z+5]=i.y,C[K+Z+6]=i.z,C[K+Z+7]=0),p===!0&&(i.fromBufferAttribute(X,W),C[K+Z+8]=i.x,C[K+Z+9]=i.y,C[K+Z+10]=i.z,C[K+Z+11]=X.itemSize===4?i.w:1)}}d={count:u,texture:B,size:new Dt(R,A)},n.set(o,d),o.addEventListener("dispose",E)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)l.getUniforms().setValue(a,"morphTexture",r.morphTexture,e);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(a,"morphTargetBaseInfluence",_),l.getUniforms().setValue(a,"morphTargetInfluences",c)}l.getUniforms().setValue(a,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(a,"morphTargetsTextureSize",d.size)}return{update:s}}function Jd(a,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(i.get(u)!==c&&(t.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(e.update(l.instanceMatrix,a.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,a.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return u}function r(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:r}}class gl extends Ae{constructor(t,e,n,i,s,r,o,l,c,h=vi){if(h!==vi&&h!==Ei)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===vi&&(n=Gn),n===void 0&&h===Ei&&(n=bi),super(null,i,s,r,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Be,this.minFilter=l!==void 0?l:Be,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const _l=new Ae,fo=new gl(1,1),xl=new rl,vl=new Bc,yl=new fl,po=[],mo=[],go=new Float32Array(16),_o=new Float32Array(9),xo=new Float32Array(4);function Ti(a,t,e){const n=a[0];if(n<=0||n>0)return a;const i=t*e;let s=po[i];if(s===void 0&&(s=new Float32Array(i),po[i]=s),t!==0){n.toArray(s,0);for(let r=1,o=0;r!==t;++r)o+=e,a[r].toArray(s,o)}return s}function he(a,t){if(a.length!==t.length)return!1;for(let e=0,n=a.length;e<n;e++)if(a[e]!==t[e])return!1;return!0}function ue(a,t){for(let e=0,n=t.length;e<n;e++)a[e]=t[e]}function Hs(a,t){let e=mo[t];e===void 0&&(e=new Int32Array(t),mo[t]=e);for(let n=0;n!==t;++n)e[n]=a.allocateTextureUnit();return e}function Qd(a,t){const e=this.cache;e[0]!==t&&(a.uniform1f(this.addr,t),e[0]=t)}function tf(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(a.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(he(e,t))return;a.uniform2fv(this.addr,t),ue(e,t)}}function ef(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(a.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(a.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(he(e,t))return;a.uniform3fv(this.addr,t),ue(e,t)}}function nf(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(a.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(he(e,t))return;a.uniform4fv(this.addr,t),ue(e,t)}}function sf(a,t){const e=this.cache,n=t.elements;if(n===void 0){if(he(e,t))return;a.uniformMatrix2fv(this.addr,!1,t),ue(e,t)}else{if(he(e,n))return;xo.set(n),a.uniformMatrix2fv(this.addr,!1,xo),ue(e,n)}}function af(a,t){const e=this.cache,n=t.elements;if(n===void 0){if(he(e,t))return;a.uniformMatrix3fv(this.addr,!1,t),ue(e,t)}else{if(he(e,n))return;_o.set(n),a.uniformMatrix3fv(this.addr,!1,_o),ue(e,n)}}function rf(a,t){const e=this.cache,n=t.elements;if(n===void 0){if(he(e,t))return;a.uniformMatrix4fv(this.addr,!1,t),ue(e,t)}else{if(he(e,n))return;go.set(n),a.uniformMatrix4fv(this.addr,!1,go),ue(e,n)}}function of(a,t){const e=this.cache;e[0]!==t&&(a.uniform1i(this.addr,t),e[0]=t)}function lf(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(a.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(he(e,t))return;a.uniform2iv(this.addr,t),ue(e,t)}}function cf(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(a.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(he(e,t))return;a.uniform3iv(this.addr,t),ue(e,t)}}function hf(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(a.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(he(e,t))return;a.uniform4iv(this.addr,t),ue(e,t)}}function uf(a,t){const e=this.cache;e[0]!==t&&(a.uniform1ui(this.addr,t),e[0]=t)}function df(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(a.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(he(e,t))return;a.uniform2uiv(this.addr,t),ue(e,t)}}function ff(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(a.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(he(e,t))return;a.uniform3uiv(this.addr,t),ue(e,t)}}function pf(a,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(a.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(he(e,t))return;a.uniform4uiv(this.addr,t),ue(e,t)}}function mf(a,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i);let s;this.type===a.SAMPLER_2D_SHADOW?(fo.compareFunction=il,s=fo):s=_l,e.setTexture2D(t||s,i)}function gf(a,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||vl,i)}function _f(a,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||yl,i)}function xf(a,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||xl,i)}function vf(a){switch(a){case 5126:return Qd;case 35664:return tf;case 35665:return ef;case 35666:return nf;case 35674:return sf;case 35675:return af;case 35676:return rf;case 5124:case 35670:return of;case 35667:case 35671:return lf;case 35668:case 35672:return cf;case 35669:case 35673:return hf;case 5125:return uf;case 36294:return df;case 36295:return ff;case 36296:return pf;case 35678:case 36198:case 36298:case 36306:case 35682:return mf;case 35679:case 36299:case 36307:return gf;case 35680:case 36300:case 36308:case 36293:return _f;case 36289:case 36303:case 36311:case 36292:return xf}}function yf(a,t){a.uniform1fv(this.addr,t)}function Sf(a,t){const e=Ti(t,this.size,2);a.uniform2fv(this.addr,e)}function Mf(a,t){const e=Ti(t,this.size,3);a.uniform3fv(this.addr,e)}function bf(a,t){const e=Ti(t,this.size,4);a.uniform4fv(this.addr,e)}function Ef(a,t){const e=Ti(t,this.size,4);a.uniformMatrix2fv(this.addr,!1,e)}function wf(a,t){const e=Ti(t,this.size,9);a.uniformMatrix3fv(this.addr,!1,e)}function Tf(a,t){const e=Ti(t,this.size,16);a.uniformMatrix4fv(this.addr,!1,e)}function Af(a,t){a.uniform1iv(this.addr,t)}function Cf(a,t){a.uniform2iv(this.addr,t)}function Pf(a,t){a.uniform3iv(this.addr,t)}function Rf(a,t){a.uniform4iv(this.addr,t)}function Df(a,t){a.uniform1uiv(this.addr,t)}function Lf(a,t){a.uniform2uiv(this.addr,t)}function If(a,t){a.uniform3uiv(this.addr,t)}function Nf(a,t){a.uniform4uiv(this.addr,t)}function Uf(a,t,e){const n=this.cache,i=t.length,s=Hs(e,i);he(n,s)||(a.uniform1iv(this.addr,s),ue(n,s));for(let r=0;r!==i;++r)e.setTexture2D(t[r]||_l,s[r])}function Ff(a,t,e){const n=this.cache,i=t.length,s=Hs(e,i);he(n,s)||(a.uniform1iv(this.addr,s),ue(n,s));for(let r=0;r!==i;++r)e.setTexture3D(t[r]||vl,s[r])}function Bf(a,t,e){const n=this.cache,i=t.length,s=Hs(e,i);he(n,s)||(a.uniform1iv(this.addr,s),ue(n,s));for(let r=0;r!==i;++r)e.setTextureCube(t[r]||yl,s[r])}function Of(a,t,e){const n=this.cache,i=t.length,s=Hs(e,i);he(n,s)||(a.uniform1iv(this.addr,s),ue(n,s));for(let r=0;r!==i;++r)e.setTexture2DArray(t[r]||xl,s[r])}function kf(a){switch(a){case 5126:return yf;case 35664:return Sf;case 35665:return Mf;case 35666:return bf;case 35674:return Ef;case 35675:return wf;case 35676:return Tf;case 5124:case 35670:return Af;case 35667:case 35671:return Cf;case 35668:case 35672:return Pf;case 35669:case 35673:return Rf;case 5125:return Df;case 36294:return Lf;case 36295:return If;case 36296:return Nf;case 35678:case 36198:case 36298:case 36306:case 35682:return Uf;case 35679:case 36299:case 36307:return Ff;case 35680:case 36300:case 36308:case 36293:return Bf;case 36289:case 36303:case 36311:case 36292:return Of}}class zf{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=vf(e.type)}}class Hf{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=kf(e.type)}}class Gf{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,r=i.length;s!==r;++s){const o=i[s];o.setValue(t,e[o.id],n)}}}const xa=/(\w+)(\])?(\[|\.)?/g;function vo(a,t){a.seq.push(t),a.map[t.id]=t}function Vf(a,t,e){const n=a.name,i=n.length;for(xa.lastIndex=0;;){const s=xa.exec(n),r=xa.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&r+2===i){vo(e,c===void 0?new zf(o,a,t):new Hf(o,a,t));break}else{let u=e.map[o];u===void 0&&(u=new Gf(o),vo(e,u)),e=u}}}class Ts{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),r=t.getUniformLocation(e,s.name);Vf(s,r,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,r=e.length;s!==r;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const r=t[i];r.id in e&&n.push(r)}return n}}function yo(a,t,e){const n=a.createShader(t);return a.shaderSource(n,e),a.compileShader(n),n}const Wf=37297;let qf=0;function Xf(a,t){const e=a.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let r=i;r<s;r++){const o=r+1;n.push(`${o===t?">":" "} ${o}: ${e[r]}`)}return n.join(`
`)}function Yf(a){const t=Xt.getPrimaries(Xt.workingColorSpace),e=Xt.getPrimaries(a);let n;switch(t===e?n="":t===Ds&&e===Rs?n="LinearDisplayP3ToLinearSRGB":t===Rs&&e===Ds&&(n="LinearSRGBToLinearDisplayP3"),a){case Tn:case Os:return[n,"LinearTransferOETF"];case $e:case vr:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",a),[n,"LinearTransferOETF"]}}function So(a,t,e){const n=a.getShaderParameter(t,a.COMPILE_STATUS),i=a.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const r=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+Xf(a.getShaderSource(t),r)}else return i}function $f(a,t){const e=Yf(t);return`vec4 ${a}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Kf(a,t){let e;switch(t){case cc:e="Linear";break;case hc:e="Reinhard";break;case uc:e="Cineon";break;case dc:e="ACESFilmic";break;case pc:e="AgX";break;case mc:e="Neutral";break;case fc:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+a+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const ps=new U;function jf(){Xt.getLuminanceCoefficients(ps);const a=ps.x.toFixed(4),t=ps.y.toFixed(4),e=ps.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Zf(a){return[a.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",a.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Fi).join(`
`)}function Jf(a){const t=[];for(const e in a){const n=a[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Qf(a,t){const e={},n=a.getProgramParameter(t,a.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=a.getActiveAttrib(t,i),r=s.name;let o=1;s.type===a.FLOAT_MAT2&&(o=2),s.type===a.FLOAT_MAT3&&(o=3),s.type===a.FLOAT_MAT4&&(o=4),e[r]={type:s.type,location:a.getAttribLocation(t,r),locationSize:o}}return e}function Fi(a){return a!==""}function Mo(a,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return a.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function bo(a,t){return a.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const tp=/^[ \t]*#include +<([\w\d./]+)>/gm;function cr(a){return a.replace(tp,np)}const ep=new Map;function np(a,t){let e=Nt[t];if(e===void 0){const n=ep.get(t);if(n!==void 0)e=Nt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return cr(e)}const ip=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Eo(a){return a.replace(ip,sp)}function sp(a,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function wo(a){let t=`precision ${a.precision} float;
...
#define LOW_PRECISION`),t}function ap(a){let t="SHADOWMAP_TYPE_BASIC";return a.shadowMapType===Wo?t="SHADOWMAP_TYPE_PCF":a.shadowMapType===Ul?t="SHADOWMAP_TYPE_PCF_SOFT":a.shadowMapType===an&&(t="SHADOWMAP_TYPE_VSM"),t}function rp(a){let t="ENVMAP_TYPE_CUBE";if(a.envMap)switch(a.envMapMode){case Si:case Mi:t="ENVMAP_TYPE_CUBE";break;case Bs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function op(a){let t="ENVMAP_MODE_REFLECTION";if(a.envMap)switch(a.envMapMode){case Mi:t="ENVMAP_MODE_REFRACTION";break}return t}function lp(a){let t="ENVMAP_BLENDING_NONE";if(a.envMap)switch(a.combine){case qo:t="ENVMAP_BLENDING_MULTIPLY";break;case oc:t="ENVMAP_BLENDING_MIX";break;case lc:t="ENVMAP_BLENDING_ADD";break}return t}function cp(a){const t=a.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function hp(a,t,e,n){const i=a.getContext(),s=e.defines;let r=e.vertexShader,o=e.fragmentShader;const l=ap(e),c=rp(e),h=op(e),u=lp(e),d=cp(e),f=Zf(e),g=Jf(s),_=i.createProgram();let p,m,M=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function Cp(a,t,e){let n=new pl;const i=new Dt,s=new Dt,r=new pe,o=new Ep({depthPacking:xc}),l=new wp,c={},h=e.maxTextureSize,u={[hn]:Te,[Te]:hn,[Ve]:Ve},d=new wn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Dt},radius:{value:4}},vertexShader:Tp,fragmentShader:Ap}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Me;g.setAttribute("position",new _e(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Ie(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Wo;let m=this.type;this.render=function(A,C,B){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;const w=a.getRenderTarget(),E=a.getActiveCubeFace(),D=a.getActiveMipmapLevel(),H=a.state;H.setBlending(bn),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const z=m!==an&&this.type===an,X=m===an&&this.type!==an;for(let K=0,W=A.length;K<W;K++){const Z=A[K],G=Z.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;i.copy(G.mapSize);const ot=G.getFrameExtents();if(i.multiply(ot),s.copy(G.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/ot.x),i.x=s.x*ot.x,G.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/ot.y),i.y=s.y*ot.y,G.mapSize.y=s.y)),G.map===null||z===!0||X===!0){const _t=this.type!==an?{minFilter:Be,magFilter:Be}:{};G.map!==null&&G.map.dispose(),G.map=new Vn(i.x,i.y,_t),G.map.texture.name=Z.name+".shadowMap",G.camera.updateProjectionMatrix()}a.setRenderTarget(G.map),a.clear();const ut=G.getViewportCount();for(let _t=0;_t<ut;_t++){const Ot=G.getViewport(_t);r.set(s.x*Ot.x,s.y*Ot.y,s.x*Ot.z,s.y*Ot.w),H.viewport(r),G.updateMatrices(Z,_t),n=G.getFrustum(),S(C,B,G.camera,Z,this.type)}G.isPointLightShadow!==!0&&this.type===an&&M(G,B),G.needsUpdate=!1}m=this.type,p.needsUpdate=!1,a.setRenderTarget(w,E,D)};function M(A,C){const B=t.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Vn(i.x,i.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,a.setRenderTarget(A.mapPass),a.clear(),a.renderBufferDirect(C,null,B,d,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,a.setRenderTarget(A.map),a.clear(),a.renderBufferDirect(C,null,B,f,_,null)}function v(A,C,B,w){let E=null;const D=B.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)E=D;else if(E=B.isPointLight===!0?l:o,a.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const H=E.uuid,z=C.uuid;let X=c[H];X===void 0&&(X={},c[H]=X);let K=X[z];K===void 0&&(K=E.clone(),X[z]=K,C.addEventListener("dispose",R)),E=K}if(E.visible=C.visible,E.wireframe=C.wireframe,w===an?E.side=C.shadowSide!==null?C.shadowSide:C.side:E.side=C.shadowSide!==null?C.shadowSide:u[C.side],E.alphaMap=C.alphaMap,E.alphaTest=C.alphaTest,E.map=C.map,E.clipShadows=C.clipShadows,E.clippingPlanes=C.clippingPlanes,E.clipIntersection=C.clipIntersection,E.displacementMap=C.displacementMap,E.displacementScale=C.displacementScale,E.displacementBias=C.displacementBias,E.wireframeLinewidth=C.wireframeLinewidth,E.linewidth=C.linewidth,B.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const H=a.properties.get(E);H.light=B}return E}function S(A,C,B,w,E){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&E===an)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,A.matrixWorld);const z=t.update(A),X=A.material;if(Array.isArray(X)){const K=z.groups;for(let W=0,Z=K.length;W<Z;W++){const G=K[W],ot=X[G.materialIndex];if(ot&&ot.visible){const ut=v(A,ot,w,E);A.onBeforeShadow(a,A,C,B,z,ut,G),a.renderBufferDirect(B,null,z,ut,A,G),A.onAfterShadow(a,A,C,B,z,ut,G)}}}else if(X.visible){const K=v(A,X,w,E);A.onBeforeShadow(a,A,C,B,z,K,null),a.renderBufferDirect(B,null,z,K,A,null),A.onAfterShadow(a,A,C,B,z,K,null)}}const H=A.children;for(let z=0,X=H.length;z<X;z++)S(H[z],C,B,w,E)}function R(A){A.target.removeEventListener("dispose",R);for(const B in c){const w=c[B],E=A.target.uuid;E in w&&(w[E].dispose(),delete w[E])}}}function Pp(a){function t(){let L=!1;const et=new pe;let q=null;const Y=new pe(0,0,0,0);return{setMask:function(it){q!==it&&!L&&(a.colorMask(it,it,it,it),q=it)},setLocked:function(it){L=it},setClear:function(it,Mt,zt,se,me){me===!0&&(it*=se,Mt*=se,zt*=se),et.set(it,Mt,zt,se),Y.equals(et)===!1&&(a.clearColor(it,Mt,zt,se),Y.copy(et))},reset:function(){L=!1,q=null,Y.set(-1,0,0,0)}}}function e(){let L=!1,et=null,q=null,Y=null;return{setTest:function(it){it?mt(a.DEPTH_TEST):ct(a.DEPTH_TEST)},setMask:function(it){et!==it&&!L&&(a.depthMask(it),et=it)},setFunc:function(it){if(q!==it){switch(it){case tc:a.depthFunc(a.NEVER);break;case ec:a.depthFunc(a.ALWAYS);break;case nc:a.depthFunc(a.LESS);break;case Cs:a.depthFunc(a.LEQUAL);break;case ic:a.depthFunc(a.EQUAL);break;case sc:a.depthFunc(a.GEQUAL);break;case ac:a.depthFunc(a.GREATER);break;case rc:a.depthFunc(a.NOTEQUAL);break;default:a.depthFunc(a.LEQUAL)}q=it}},setLocked:function(it){L=it},setClear:function(it){Y!==it&&(a.clearDepth(it),Y=it)},reset:function(){L=!1,et=null,q=null,Y=null}}}function n(){let L=!1,et=null,q=null,Y=null,it=null,Mt=null,zt=null,se=null,me=null;return{setTest:function(Gt){L||(Gt?mt(a.STENCIL_TEST):ct(a.STENCIL_TEST))},setMask:function(Gt){et!==Gt&&!L&&(a.stencilMask(Gt),et=Gt)},setFunc:function(Gt,Je,Ye){(q!==Gt||Y!==Je||it!==Ye)&&(a.stencilFunc(Gt,Je,Ye),q=Gt,Y=Je,it=Ye)},setOp:function(Gt,Je,Ye){(Mt!==Gt||zt!==Je||se!==Ye)&&(a.stencilOp(Gt,Je,Ye),Mt=Gt,zt=Je,se=Ye)},setLocked:function(Gt){L=Gt},setClear:function(Gt){me!==Gt&&(a.clearStencil(Gt),me=Gt)},reset:function(){L=!1,et=null,q=null,Y=null,it=null,Mt=null,zt=null,se=null,me=null}}}const i=new t,s=new e,r=new n,o=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,p=null,m=null,M=null,v=null,S=null,R=null,A=new Ht(0,0,0),C=0,B=!1,w=null,E=null,D=null,H=null,z=null;const X=a.getParameter(a.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,W=0;const Z=a.getParameter(a.VERSION);Z.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(Z)[1]),K=W>=1):Z.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),K=W>=2);let G=null,ot={};const ut=a.getParameter(a.SCISSOR_BOX),_t=a.getParameter(a.VIEWPORT),Ot=new pe().fromArray(ut),$t=new pe().fromArray(_t);function V(L,et,q,Y){const it=new Uint8Array(4),Mt=a.createTexture();a.bindTexture(L,Mt),a.texParameteri(L,a.TEXTURE_MIN_FILTER,a.NEAREST),a.texParameteri(L,a.TEXTURE_MAG_FILTER,a.NEAREST);for(let zt=0;zt<q;zt++)L===a.TEXTURE_3D||L===a.TEXTURE_2D_ARRAY?a.texImage3D(et,0,a.RGBA,1,1,Y,0,a.RGBA,a.UNSIGNED_BYTE,it):a.texImage2D(et+zt,0,a.RGBA,1,1,0,a.RGBA,a.UNSIGNED_BYTE,it);return Mt}const Q={};Q[a.TEXTURE_2D]=V(a.TEXTURE_2D,a.TEXTURE_2D,1),Q[a.TEXTURE_CUBE_MAP]=V(a.TEXTURE_CUBE_MAP,a.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[a.TEXTURE_2D_ARRAY]=V(a.TEXTURE_2D_ARRAY,a.TEXTURE_2D_ARRAY,1,1),Q[a.TEXTURE_3D]=V(a.TEXTURE_3D,a.TEXTURE_3D,1,1),i.setClear(0,0,0,1),s.setClear(1),r.setClear(0),mt(a.DEPTH_TEST),s.setFunc(Cs),Kt(!1),yt(Ir),mt(a.CULL_FACE),ne(bn);function mt(L){c[L]!==!0&&(a.enable(L),c[L]=!0)}function ct(L){c[L]!==!1&&(a.disable(L),c[L]=!1)}function Et(L,et){return h[L]!==et?(a.bindFramebuffer(L,et),h[L]=et,L===a.DRAW_FRAMEBUFFER&&(h[a.FRAMEBUFFER]=et),L===a.FRAMEBUFFER&&(h[a.DRAW_FRAMEBUFFER]=et),!0):!1}function Pt(L,et){let q=d,Y=!1;if(L){q=u.get(et),q===void 0&&(q=[],u.set(et,q));const it=L.textures;if(q.length!==it.length||q[0]!==a.COLOR_ATTACHMENT0){for(let Mt=0,zt=it.length;Mt<zt;Mt++)q[Mt]=a.COLOR_ATTACHMENT0+Mt;q.length=it.length,Y=!0}}else q[0]!==a.BACK&&(q[0]=a.BACK,Y=!0);Y&&a.drawBuffers(q)}function Bt(L){return f!==L?(a.useProgram(L),f=L,!0):!1}const Qt={[Un]:a.FUNC_ADD,[Bl]:a.FUNC_SUBTRACT,[Ol]:a.FUNC_REVERSE_SUBTRACT};Qt[kl]=a.MIN,Qt[zl]=a.MAX;const P={[Hl]:a.ZERO,[Gl]:a.ONE,[Vl]:a.SRC_COLOR,[Ra]:a.SRC_ALPHA,[Kl]:a.SRC_ALPHA_SATURATE,[Yl]:a.DST_COLOR,[ql]:a.DST_ALPHA,[Wl]:a.ONE_MINUS_SRC_COLOR,[Da]:a.ONE_MINUS_SRC_ALPHA,[$l]:a.ONE_MINUS_DST_COLOR,[Xl]:a.ONE_MINUS_DST_ALPHA,[jl]:a.CONSTANT_COLOR,[Zl]:a.ONE_MINUS_CONSTANT_COLOR,[Jl]:a.CONSTANT_ALPHA,[Ql]:a.ONE_MINUS_CONSTANT_ALPHA};function ne(L,et,q,Y,it,Mt,zt,se,me,Gt){if(L===bn){g===!0&&(ct(a.BLEND),g=!1);return}if(g===!1&&(mt(a.BLEND),g=!0),L!==Fl){if(L!==_||Gt!==B){if((p!==Un||v!==Un)&&(a.blendEquation(a.FUNC_ADD),p=Un,v=Un),Gt)switch(L){case xi:a.blendFuncSeparate(a.ONE,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case Nr:a.blendFunc(a.ONE,a.ONE);break;case Ur:a.blendFuncSeparate(a.ZERO,a.ONE_MINUS_SRC_COLOR,a.ZERO,a.ONE);break;case Fr:a.blendFuncSeparate(a.ZERO,a.SRC_COLOR,a.ZERO,a.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case xi:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case Nr:a.blendFunc(a.SRC_ALPHA,a.ONE);break;case Ur:a.blendFuncSeparate(a.ZERO,a.ONE_MINUS_SRC_COLOR,a.ZERO,a.ONE);break;case Fr:a.blendFunc(a.ZERO,a.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}m=null,M=null,S=null,R=null,A.set(0,0,0),C=0,_=L,B=Gt}return}it=it||et,Mt=Mt||q,zt=zt||Y,(et!==p||it!==v)&&(a.blendEquationSeparate(Qt[et],Qt[it]),p=et,v=it),(q!==m||Y!==M||Mt!==S||zt!==R)&&(a.blendFuncSeparate(P[q],P[Y],P[Mt],P[zt]),m=q,M=Y,S=Mt,R=zt),(se.equals(A)===!1||me!==C)&&(a.blendColor(se.r,se.g,se.b,me),A.copy(se),C=me),_=L,B=!1}function Yt(L,et){L.side===Ve?ct(a.CULL_FACE):mt(a.CULL_FACE);let q=L.side===Te;et&&(q=!q),Kt(q),L.blending===xi&&L.transparent===!1?ne(bn):ne(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),s.setFunc(L.depthFunc),s.setTest(L.depthTest),s.setMask(L.depthWrite),i.setMask(L.colorWrite);const Y=L.stencilWrite;r.setTest(Y),Y&&(r.setMask(L.stencilWriteMask),r.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),r.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),At(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?mt(a.SAMPLE_ALPHA_TO_COVERAGE):ct(a.SAMPLE_ALPHA_TO_COVERAGE)}function Kt(L){w!==L&&(L?a.frontFace(a.CW):a.frontFace(a.CCW),w=L)}function yt(L){L!==Il?(mt(a.CULL_FACE),L!==E&&(L===Ir?a.cullFace(a.BACK):L===Nl?a.cullFace(a.FRONT):a.cullFace(a.FRONT_AND_BACK))):ct(a.CULL_FACE),E=L}function ie(L){L!==D&&(K&&a.lineWidth(L),D=L)}function At(L,et,q){L?(mt(a.POLYGON_OFFSET_FILL),(H!==et||z!==q)&&(a.polygonOffset(et,q),H=et,z=q)):ct(a.POLYGON_OFFSET_FILL)}function Rt(L){L?mt(a.SCISSOR_TEST):ct(a.SCISSOR_TEST)}function T(L){L===void 0&&(L=a.TEXTURE0+X-1),G!==L&&(a.activeTexture(L),G=L)}function y(L,et,q){q===void 0&&(G===null?q=a.TEXTURE0+X-1:q=G);let Y=ot[q];Y===void 0&&(Y={type:void 0,texture:void 0},ot[q]=Y),(Y.type!==L||Y.texture!==et)&&(G!==q&&(a.activeTexture(q),G=q),a.bindTexture(L,et||Q[L]),Y.type=L,Y.texture=et)}function k(){const L=ot[G];L!==void 0&&L.type!==void 0&&(a.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function $(){try{a.compressedTexImage2D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function J(){try{a.compressedTexImage3D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function j(){try{a.texSubImage2D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function St(){try{a.texSubImage3D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function at(){try{a.compressedTexSubImage2D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ht(){try{a.compressedTexSubImage3D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Lt(){try{a.texStorage2D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function tt(){try{a.texStorage3D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function lt(){try{a.texImage2D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function kt(){try{a.texImage3D.apply(a,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Tt(L){Ot.equals(L)===!1&&(a.scissor(L.x,L.y,L.z,L.w),Ot.copy(L))}function dt(L){$t.equals(L)===!1&&(a.viewport(L.x,L.y,L.z,L.w),$t.copy(L))}function Ct(L,et){let q=l.get(et);q===void 0&&(q=new WeakMap,l.set(et,q));let Y=q.get(L);Y===void 0&&(Y=a.getUniformBlockIndex(et,L.name),q.set(L,Y))}function Ft(L,et){const Y=l.get(et).get(L);o.get(et)!==Y&&(a.uniformBlockBinding(et,Y,L.__bindingPointIndex),o.set(et,Y))}function Jt(){a.disable(a.BLEND),a.disable(a.CULL_FACE),a.disable(a.DEPTH_TEST),a.disable(a.POLYGON_OFFSET_FILL),a.disable(a.SCISSOR_TEST),a.disable(a.STENCIL_TEST),a.disable(a.SAMPLE_ALPHA_TO_COVERAGE),a.blendEquation(a.FUNC_ADD),a.blendFunc(a.ONE,a.ZERO),a.blendFuncSeparate(a.ONE,a.ZERO,a.ONE,a.ZERO),a.blendColor(0,0,0,0),a.colorMask(!0,!0,!0,!0),a.clearColor(0,0,0,0),a.depthMask(!0),a.depthFunc(a.LESS),a.clearDepth(1),a.stencilMask(4294967295),a.stencilFunc(a.ALWAYS,0,4294967295),a.stencilOp(a.KEEP,a.KEEP,a.KEEP),a.clearStencil(0),a.cullFace(a.BACK),a.frontFace(a.CCW),a.polygonOffset(0,0),a.activeTexture(a.TEXTURE0),a.bindFramebuffer(a.FRAMEBUFFER,null),a.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),a.bindFramebuffer(a.READ_FRAMEBUFFER,null),a.useProgram(null),a.lineWidth(1),a.scissor(0,0,a.canvas.width,a.canvas.height),a.viewport(0,0,a.canvas.width,a.canvas.height),c={},G=null,ot={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,p=null,m=null,M=null,v=null,S=null,R=null,A=new Ht(0,0,0),C=0,B=!1,w=null,E=null,D=null,H=null,z=null,Ot.set(0,0,a.canvas.width,a.canvas.height),$t.set(0,0,a.canvas.width,a.canvas.height),i.reset(),s.reset(),r.reset()}return{buffers:{color:i,depth:s,stencil:r},enable:mt,disable:ct,bindFramebuffer:Et,drawBuffers:Pt,useProgram:Bt,setBlending:ne,setMaterial:Yt,setFlipSided:Kt,setCullFace:yt,setLineWidth:ie,setPolygonOffset:At,setScissorTest:Rt,activeTexture:T,bindTexture:y,unbindTexture:k,compressedTexImage2D:$,compressedTexImage3D:J,texImage2D:lt,texImage3D:kt,updateUBOMapping:Ct,uniformBlockBinding:Ft,texStorage2D:Lt,texStorage3D:tt,texSubImage2D:j,texSubImage3D:St,compressedTexSubImage2D:at,compressedTexSubImage3D:ht,scissor:Tt,viewport:dt,reset:Jt}}function Po(a,t,e,n){const i=Rp(n);switch(e){case jo:return a*t;case Jo:return a*t;case Qo:return a*t*2;case tl:return a*t/i.components*i.byteLength;case gr:return a*t/i.components*i.byteLength;case el:return a*t*2/i.components*i.byteLength;case _r:return a*t*2/i.components*i.byteLength;case Zo:return a*t*3/i.components*i.byteLength;case Xe:return a*t*4/i.components*i.byteLength;case xr:return a*t*4/i.components*i.byteLength;case ys:case Ss:return Math.floor((a+3)/4)*Math.floor((t+3)/4)*8;case Ms:case bs:return Math.floor((a+3)/4)*Math.floor((t+3)/4)*16;case Ba:case ka:return Math.max(a,16)*Math.max(t,8)/4;case Fa:case Oa:return Math.max(a,8)*Math.max(t,8)/2;case za:case Ha:return Math.floor((a+3)/4)*Math.floor((t+3)/4)*8;case Ga:return Math.floor((a+3)/4)*Math.floor((t+3)/4)*16;case Va:return Math.floor((a+3)/4)*Math.floor((t+3)/4)*16;case Wa:return Math.floor((a+4)/5)*Math.floor((t+3)/4)*16;case qa:return Math.floor((a+4)/5)*Math.floor((t+4)/5)*16;case Xa:return Math.floor((a+5)/6)*Math.floor((t+4)/5)*16;case Ya:return Math.floor((a+5)/6)*Math.floor((t+5)/6)*16;case $a:return Math.floor((a+7)/8)*Math.floor((t+4)/5)*16;case Ka:return Math.floor((a+7)/8)*Math.floor((t+5)/6)*16;case ja:return Math.floor((a+7)/8)*Math.floor((t+7)/8)*16;case Za:return Math.floor((a+9)/10)*Math.floor((t+4)/5)*16;case Ja:return Math.floor((a+9)/10)*Math.floor((t+5)/6)*16;case Qa:return Math.floor((a+9)/10)*Math.floor((t+7)/8)*16;case tr:return Math.floor((a+9)/10)*Math.floor((t+9)/10)*16;case er:return Math.floor((a+11)/12)*Math.floor((t+9)/10)*16;case nr:return Math.floor((a+11)/12)*Math.floor((t+11)/12)*16;case Es:case ir:case sr:return Math.ceil(a/4)*Math.ceil(t/4)*16;case nl:case ar:return Math.ceil(a/4)*Math.ceil(t/4)*8;case rr:case or:return Math.ceil(a/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Rp(a){switch(a){case un:case Yo:return{byteLength:1,components:1};case ki:case $o:case zi:return{byteLength:2,components:1};case pr:case mr:return{byteLength:2,components:4};case Gn:case fr:case on:return{byteLength:4,components:1};case Ko:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${a}.`)}function Dp(a,t,e,n,i,s,r){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Dt,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,y){return f?new OffscreenCanvas(T,y):Is("canvas")}function _(T,y,k){let $=1;const J=Rt(T);if((J.width>k||J.height>k)&&($=k/Math.max(J.width,J.height)),$<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const j=Math.floor($*J.width),St=Math.floor($*J.height);u===void 0&&(u=g(j,St));const at=y?g(j,St):u;return at.width=j,at.height=St,at.getContext("2d").drawImage(T,0,0,j,St),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+j+"x"+St+")."),at}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),T;return T}function p(T){return T.generateMipmaps&&T.minFilter!==Be&&T.minFilter!==We}function m(T){a.generateMipmap(T)}function M(T,y,k,$,J=!1){if(T!==null){if(a[T]!==void 0)return a[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let j=y;if(y===a.RED&&(k===a.FLOAT&&(j=a.R32F),k===a.HALF_FLOAT&&(j=a.R16F),k===a.UNSIGNED_BYTE&&(j=a.R8)),y===a.RED_INTEGER&&(k===a.UNSIGNED_BYTE&&(j=a.R8UI),k===a.UNSIGNED_SHORT&&(j=a.R16UI),k===a.UNSIGNED_INT&&(j=a.R32UI),k===a.BYTE&&(j=a.R8I),k===a.SHORT&&(j=a.R16I),k===a.INT&&(j=a.R32I)),y===a.RG&&(k===a.FLOAT&&(j=a.RG32F),k===a.HALF_FLOAT&&(j=a.RG16F),k===a.UNSIGNED_BYTE&&(j=a.RG8)),y===a.RG_INTEGER&&(k===a.UNSIGNED_BYTE&&(j=a.RG8UI),k===a.UNSIGNED_SHORT&&(j=a.RG16UI),k===a.UNSIGNED_INT&&(j=a.RG32UI),k===a.BYTE&&(j=a.RG8I),k===a.SHORT&&(j=a.RG16I),k===a.INT&&(j=a.RG32I)),y===a.RGB&&k===a.UNSIGNED_INT_5_9_9_9_REV&&(j=a.RGB9_E5),y===a.RGBA){const St=J?Ps:Xt.getTransfer($);k===a.FLOAT&&(j=a.RGBA32F),k===a.HALF_FLOAT&&(j=a.RGBA16F),k===a.UNSIGNED_BYTE&&(j=St===Zt?a.SRGB8_ALPHA8:a.RGBA8),k===a.UNSIGNED_SHORT_4_4_4_4&&(j=a.RGBA4),k===a.UNSIGNED_SHORT_5_5_5_1&&(j=a.RGB5_A1)}return(j===a.R16F||j===a.R32F||j===a.RG16F||j===a.RG32F||j===a.RGBA16F||j===a.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function v(T,y){let k;return T?y===null||y===Gn||y===bi?k=a.DEPTH24_STENCIL8:y===on?k=a.DEPTH32F_STENCIL8:y===ki&&(k=a.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===Gn||y===bi?k=a.DEPTH_COMPONENT24:y===on?k=a.DEPTH_COMPONENT32F:y===ki&&(k=a.DEPTH_COMPONENT16),k}function S(T,y){return p(T)===!0||T.isFramebufferTexture&&T.minFilter!==Be&&T.minFilter!==We?Math.log2(Math.max(y.width,y.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?y.mipmaps.length:1}function R(T){const y=T.target;y.removeEventListener("dispose",R),C(y),y.isVideoTexture&&h.delete(y)}function A(T){const y=T.target;y.removeEventListener("dispose",A),w(y)}function C(T){const y=n.get(T);if(y.__webglInit===void 0)return;const k=T.source,$=d.get(k);if($){const J=$[y.__cacheKey];J.usedTimes--,J.usedTimes===0&&B(T),Object.keys($).length===0&&d.delete(k)}n.remove(T)}function B(T){const y=n.get(T);a.deleteTexture(y.__webglTexture);const k=T.source,$=d.get(k);delete $[y.__cacheKey],r.memory.textures--}function w(T){const y=n.get(T);if(T.depthTexture&&T.depthTexture.dispose(),T.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(y.__webglFramebuffer[$]))for(let J=0;J<y.__webglFramebuffer[$].length;J++)a.deleteFramebuffer(y.__webglFramebuffer[$][J]);else a.deleteFramebuffer(y.__webglFramebuffer[$]);y.__webglDepthbuffer&&a.deleteRenderbuffer(y.__webglDepthbuffer[$])}else{if(Array.isArray(y.__webglFramebuffer))for(let $=0;$<y.__webglFramebuffer.length;$++)a.deleteFramebuffer(y.__webglFramebuffer[$]);else a.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&a.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&a.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let $=0;$<y.__webglColorRenderbuffer.length;$++)y.__webglColorRenderbuffer[$]&&a.deleteRenderbuffer(y.__webglColorRenderbuffer[$]);y.__webglDepthRenderbuffer&&a.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const k=T.textures;for(let $=0,J=k.length;$<J;$++){const j=n.get(k[$]);j.__webglTexture&&(a.deleteTexture(j.__webglTexture),r.memory.textures--),n.remove(k[$])}n.remove(T)}let E=0;function D(){E=0}function H(){const T=E;return T>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),E+=1,T}function z(T){const y=[];return y.push(T.wrapS),y.push(T.wrapT),y.push(T.wrapR||0),y.push(T.magFilter),y.push(T.minFilter),y.push(T.anisotropy),y.push(T.internalFormat),y.push(T.format),y.push(T.type),y.push(T.generateMipmaps),y.push(T.premultiplyAlpha),y.push(T.flipY),y.push(T.unpackAlignment),y.push(T.colorSpace),y.join()}function X(T,y){const k=n.get(T);if(T.isVideoTexture&&ie(T),T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){const $=T.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$t(k,T,y);return}}e.bindTexture(a.TEXTURE_2D,k.__webglTexture,a.TEXTURE0+y)}function K(T,y){const k=n.get(T);if(T.version>0&&k.__version!==T.version){$t(k,T,y);return}e.bindTexture(a.TEXTURE_2D_ARRAY,k.__webglTexture,a.TEXTURE0+y)}function W(T,y){const k=n.get(T);if(T.version>0&&k.__version!==T.version){$t(k,T,y);return}e.bindTexture(a.TEXTURE_3D,k.__webglTexture,a.TEXTURE0+y)}function Z(T,y){const k=n.get(T);if(T.version>0&&k.__version!==T.version){V(k,T,y);return}e.bindTexture(a.TEXTURE_CUBE_MAP,k.__webglTexture,a.TEXTURE0+y)}const G={[Na]:a.REPEAT,[zn]:a.CLAMP_TO_EDGE,[Ua]:a.MIRRORED_REPEAT},ot={[Be]:a.NEAREST,[gc]:a.NEAREST_MIPMAP_NEAREST,[Yi]:a.NEAREST_MIPMAP_LINEAR,[We]:a.LINEAR,[Ys]:a.LINEAR_MIPMAP_NEAREST,[Hn]:a.LINEAR_MIPMAP_LINEAR},ut={[Sc]:a.NEVER,[Ac]:a.ALWAYS,[Mc]:a.LESS,[il]:a.LEQUAL,[bc]:a.EQUAL,[Tc]:a.GEQUAL,[Ec]:a.GREATER,[wc]:a.NOTEQUAL};function _t(T,y){if(y.type===on&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===We||y.magFilter===Ys||y.magFilter===Yi||y.magFilter===Hn||y.minFilter===We||y.minFilter===Ys||y.minFilter===Yi||y.minFilter===Hn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),a.texParameteri(T,a.TEXTURE_WRAP_S,G[y.wrapS]),a.texParameteri(T,a.TEXTURE_WRAP_T,G[y.wrapT]),(T===a.TEXTURE_3D||T===a.TEXTURE_2D_ARRAY)&&a.texParameteri(T,a.TEXTURE_WRAP_R,G[y.wrapR]),a.texParameteri(T,a.TEXTURE_MAG_FILTER,ot[y.magFilter]),a.texParameteri(T,a.TEXTURE_MIN_FILTER,ot[y.minFilter]),y.compareFunction&&(a.texParameteri(T,a.TEXTURE_COMPARE_MODE,a.COMPARE_REF_TO_TEXTURE),a.texParameteri(T,a.TEXTURE_COMPARE_FUNC,ut[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===Be||y.minFilter!==Yi&&y.minFilter!==Hn||y.type===on&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){const k=t.get("EXT_texture_filter_anisotropic");a.texParameterf(T,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,i.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function Ot(T,y){let k=!1;T.__webglInit===void 0&&(T.__webglInit=!0,y.addEventListener("dispose",R));const $=y.source;let J=d.get($);J===void 0&&(J={},d.set($,J));const j=z(y);if(j!==T.__cacheKey){J[j]===void 0&&(J[j]={texture:a.createTexture(),usedTimes:0},r.memory.textures++,k=!0),J[j].usedTimes++;const St=J[T.__cacheKey];St!==void 0&&(J[T.__cacheKey].usedTimes--,St.usedTimes===0&&B(y)),T.__cacheKey=j,T.__webglTexture=J[j].texture}return k}function $t(T,y,k){let $=a.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&($=a.TEXTURE_2D_ARRAY),y.isData3DTexture&&($=a.TEXTURE_3D);const J=Ot(T,y),j=y.source;e.bindTexture($,T.__webglTexture,a.TEXTURE0+k);const St=n.get(j);if(j.version!==St.__version||J===!0){e.activeTexture(a.TEXTURE0+k);const at=Xt.getPrimaries(Xt.workingColorSpace),ht=y.colorSpace===Mn?null:Xt.getPrimaries(y.colorSpace),Lt=y.colorSpace===Mn||at===ht?a.NONE:a.BROWSER_DEFAULT_WEBGL;a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,y.flipY),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),a.pixelStorei(a.UNPACK_ALIGNMENT,y.unpackAlignment),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,Lt);let tt=_(y.image,!1,i.maxTextureSize);tt=At(y,tt);const lt=s.convert(y.format,y.colorSpace),kt=s.convert(y.type);let Tt=M(y.internalFormat,lt,kt,y.colorSpace,y.isVideoTexture);_t($,y);let dt;const Ct=y.mipmaps,Ft=y.isVideoTexture!==!0,Jt=St.__version===void 0||J===!0,L=j.dataReady,et=S(y,tt);if(y.isDepthTexture)Tt=v(y.format===Ei,y.type),Jt&&(Ft?e.texStorage2D(a.TEXTURE_2D,1,Tt,tt.width,tt.height):e.texImage2D(a.TEXTURE_2D,0,Tt,tt.width,tt.height,0,lt,kt,null));else if(y.isDataTexture)if(Ct.length>0){Ft&&Jt&&e.texStorage2D(a.TEXTURE_2D,et,Tt,Ct[0].width,Ct[0].height);for(let q=0,Y=Ct.length;q<Y;q++)dt=Ct[q],Ft?L&&e.texSubImage2D(a.TEXTURE_2D,q,0,0,dt.width,dt.height,lt,kt,dt.data):e.texImage2D(a.TEXTURE_2D,q,Tt,dt.width,dt.height,0,lt,kt,dt.data);y.generateMipmaps=!1}else Ft?(Jt&&e.texStorage2D(a.TEXTURE_2D,et,Tt,tt.width,tt.height),L&&e.texSubImage2D(a.TEXTURE_2D,0,0,0,tt.width,tt.height,lt,kt,tt.data)):e.texImage2D(a.TEXTURE_2D,0,Tt,tt.width,tt.height,0,lt,kt,tt.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){Ft&&Jt&&e.texStorage3D(a.TEXTURE_2D_ARRAY,et,Tt,Ct[0].width,Ct[0].height,tt.depth);for(let q=0,Y=Ct.length;q<Y;q++)if(dt=Ct[q],y.format!==Xe)if(lt!==null)if(Ft){if(L)if(y.layerUpdates.size>0){const it=Po(dt.width,dt.height,y.format,y.type);for(const Mt of y.layerUpdates){const zt=dt.data.subarray(Mt*it/dt.data.BYTES_PER_ELEMENT,(Mt+1)*it/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,q,0,0,Mt,dt.width,dt.height,1,lt,zt,0,0)}y.clearLayerUpdates()}else e.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,q,0,0,0,dt.width,dt.height,tt.depth,lt,dt.data,0,0)}else e.compressedTexImage3D(a.TEXTURE_2D_ARRAY,q,Tt,dt.width,dt.height,tt.depth,0,dt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ft?L&&e.texSubImage3D(a.TEXTURE_2D_ARRAY,q,0,0,0,dt.width,dt.height,tt.depth,lt,kt,dt.data):e.texImage3D(a.TEXTURE_2D_ARRAY,q,Tt,dt.width,dt.height,tt.depth,0,lt,kt,dt.data)}else{Ft&&Jt&&e.texStorage2D(a.TEXTURE_2D,et,Tt,Ct[0].width,Ct[0].height);for(let q=0,Y=Ct.length;q<Y;q++)dt=Ct[q],y.format!==Xe?lt!==null?Ft?L&&e.compressedTexSubImage2D(a.TEXTURE_2D,q,0,0,dt.width,dt.height,lt,dt.data):e.compressedTexImage2D(a.TEXTURE_2D,q,Tt,dt.width,dt.height,0,dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ft?L&&e.texSubImage2D(a.TEXTURE_2D,q,0,0,dt.width,dt.height,lt,kt,dt.data):e.texImage2D(a.TEXTURE_2D,q,Tt,dt.width,dt.height,0,lt,kt,dt.data)}else if(y.isDataArrayTexture)if(Ft){if(Jt&&e.texStorage3D(a.TEXTURE_2D_ARRAY,et,Tt,tt.width,tt.height,tt.depth),L)if(y.layerUpdates.size>0){const q=Po(tt.width,tt.height,y.format,y.type);for(const Y of y.layerUpdates){const it=tt.data.subarray(Y*q/tt.data.BYTES_PER_ELEMENT,(Y+1)*q/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,Y,tt.width,tt.height,1,lt,kt,it)}y.clearLayerUpdates()}else e.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,lt,kt,tt.data)}else e.texImage3D(a.TEXTURE_2D_ARRAY,0,Tt,tt.width,tt.height,tt.depth,0,lt,kt,tt.data);else if(y.isData3DTexture)Ft?(Jt&&e.texStorage3D(a.TEXTURE_3D,et,Tt,tt.width,tt.height,tt.depth),L&&e.texSubImage3D(a.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,lt,kt,tt.data)):e.texImage3D(a.TEXTURE_3D,0,Tt,tt.width,tt.height,tt.depth,0,lt,kt,tt.data);else if(y.isFramebufferTexture){if(Jt)if(Ft)e.texStorage2D(a.TEXTURE_2D,et,Tt,tt.width,tt.height);else{let q=tt.width,Y=tt.height;for(let it=0;it<et;it++)e.texImage2D(a.TEXTURE_2D,it,Tt,q,Y,0,lt,kt,null),q>>=1,Y>>=1}}else if(Ct.length>0){if(Ft&&Jt){const q=Rt(Ct[0]);e.texStorage2D(a.TEXTURE_2D,et,Tt,q.width,q.height)}for(let q=0,Y=Ct.length;q<Y;q++)dt=Ct[q],Ft?L&&e.texSubImage2D(a.TEXTURE_2D,q,0,0,lt,kt,dt):e.texImage2D(a.TEXTURE_2D,q,Tt,lt,kt,dt);y.generateMipmaps=!1}else if(Ft){if(Jt){const q=Rt(tt);e.texStorage2D(a.TEXTURE_2D,et,Tt,q.width,q.height)}L&&e.texSubImage2D(a.TEXTURE_2D,0,0,0,lt,kt,tt)}else e.texImage2D(a.TEXTURE_2D,0,Tt,lt,kt,tt);p(y)&&m($),St.__version=j.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function V(T,y,k){if(y.image.length!==6)return;const $=Ot(T,y),J=y.source;e.bindTexture(a.TEXTURE_CUBE_MAP,T.__webglTexture,a.TEXTURE0+k);const j=n.get(J);if(J.version!==j.__version||$===!0){e.activeTexture(a.TEXTURE0+k);const St=Xt.getPrimaries(Xt.workingColorSpace),at=y.colorSpace===Mn?null:Xt.getPrimaries(y.colorSpace),ht=y.colorSpace===Mn||St===at?a.NONE:a.BROWSER_DEFAULT_WEBGL;a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,y.flipY),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),a.pixelStorei(a.UNPACK_ALIGNMENT,y.unpackAlignment),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,ht);const Lt=y.isCompressedTexture||y.image[0].isCompressedTexture,tt=y.image[0]&&y.image[0].isDataTexture,lt=[];for(let Y=0;Y<6;Y++)!Lt&&!tt?lt[Y]=_(y.image[Y],!0,i.maxCubemapSize):lt[Y]=tt?y.image[Y].image:y.image[Y],lt[Y]=At(y,lt[Y]);const kt=lt[0],Tt=s.convert(y.format,y.colorSpace),dt=s.convert(y.type),Ct=M(y.internalFormat,Tt,dt,y.colorSpace),Ft=y.isVideoTexture!==!0,Jt=j.__version===void 0||$===!0,L=J.dataReady;let et=S(y,kt);_t(a.TEXTURE_CUBE_MAP,y);let q;if(Lt){Ft&&Jt&&e.texStorage2D(a.TEXTURE_CUBE_MAP,et,Ct,kt.width,kt.height);for(let Y=0;Y<6;Y++){q=lt[Y].mipmaps;for(let it=0;it<q.length;it++){const Mt=q[it];y.format!==Xe?Tt!==null?Ft?L&&e.compressedTexSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it,0,0,Mt.width,Mt.height,Tt,Mt.data):e.compressedTexImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it,Ct,Mt.width,Mt.height,0,Mt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ft?L&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it,0,0,Mt.width,Mt.height,Tt,dt,Mt.data):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it,Ct,Mt.width,Mt.height,0,Tt,dt,Mt.data)}}}else{if(q=y.mipmaps,Ft&&Jt){q.length>0&&et++;const Y=Rt(lt[0]);e.texStorage2D(a.TEXTURE_CUBE_MAP,et,Ct,Y.width,Y.height)}for(let Y=0;Y<6;Y++)if(tt){Ft?L&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,lt[Y].width,lt[Y].height,Tt,dt,lt[Y].data):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Ct,lt[Y].width,lt[Y].height,0,Tt,dt,lt[Y].data);for(let it=0;it<q.length;it++){const zt=q[it].image[Y].image;Ft?L&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it+1,0,0,zt.width,zt.height,Tt,dt,zt.data):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it+1,Ct,zt.width,zt.height,0,Tt,dt,zt.data)}}else{Ft?L&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,Tt,dt,lt[Y]):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Ct,Tt,dt,lt[Y]);for(let it=0;it<q.length;it++){const Mt=q[it];Ft?L&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it+1,0,0,Tt,dt,Mt.image[Y]):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Y,it+1,Ct,Tt,dt,Mt.image[Y])}}}p(y)&&m(a.TEXTURE_CUBE_MAP),j.__version=J.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function Q(T,y,k,$,J,j){const St=s.convert(k.format,k.colorSpace),at=s.convert(k.type),ht=M(k.internalFormat,St,at,k.colorSpace);if(!n.get(y).__hasExternalTextures){const tt=Math.max(1,y.width>>j),lt=Math.max(1,y.height>>j);J===a.TEXTURE_3D||J===a.TEXTURE_2D_ARRAY?e.texImage3D(J,j,ht,tt,lt,y.depth,0,St,at,null):e.texImage2D(J,j,ht,tt,lt,0,St,at,null)}e.bindFramebuffer(a.FRAMEBUFFER,T),yt(y)?o.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,$,J,n.get(k).__webglTexture,0,Kt(y)):(J===a.TEXTURE_2D||J>=a.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=a.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&a.framebufferTexture2D(a.FRAMEBUFFER,$,J,n.get(k).__webglTexture,j),e.bindFramebuffer(a.FRAMEBUFFER,null)}function mt(T,y,k){if(a.bindRenderbuffer(a.RENDERBUFFER,T),y.depthBuffer){const $=y.depthTexture,J=$&&$.isDepthTexture?$.type:null,j=v(y.stencilBuffer,J),St=y.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,at=Kt(y);yt(y)?o.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,at,j,y.width,y.height):k?a.renderbufferStorageMultisample(a.RENDERBUFFER,at,j,y.width,y.height):a.renderbufferStorage(a.RENDERBUFFER,j,y.width,y.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,St,a.RENDERBUFFER,T)}else{const $=y.textures;for(let J=0;J<$.length;J++){const j=$[J],St=s.convert(j.format,j.colorSpace),at=s.convert(j.type),ht=M(j.internalFormat,St,at,j.colorSpace),Lt=Kt(y);k&&yt(y)===!1?a.renderbufferStorageMultisample(a.RENDERBUFFER,Lt,ht,y.width,y.height):yt(y)?o.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,Lt,ht,y.width,y.height):a.renderbufferStorage(a.RENDERBUFFER,ht,y.width,y.height)}}a.bindRenderbuffer(a.RENDERBUFFER,null)}function ct(T,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(a.FRAMEBUFFER,T),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(y.depthTexture).__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),X(y.depthTexture,0);const $=n.get(y.depthTexture).__webglTexture,J=Kt(y);if(y.depthTexture.format===vi)yt(y)?o.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,a.DEPTH_ATTACHMENT,a.TEXTURE_2D,$,0,J):a.framebufferTexture2D(a.FRAMEBUFFER,a.DEPTH_ATTACHMENT,a.TEXTURE_2D,$,0);else if(y.depthTexture.format===Ei)yt(y)?o.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,a.DEPTH_STENCIL_ATTACHMENT,a.TEXTURE_2D,$,0,J):a.framebufferTexture2D(a.FRAMEBUFFER,a.DEPTH_STENCIL_ATTACHMENT,a.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function Et(T){const y=n.get(T),k=T.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==T.depthTexture){const $=T.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),$){const J=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,$.removeEventListener("dispose",J)};$.addEventListener("dispose",J),y.__depthDisposeCallback=J}y.__boundDepthTexture=$}if(T.depthTexture&&!y.__autoAllocateDepthBuffer){if(k)throw new Error("target.depthTexture not supported in Cube render targets");ct(y.__webglFramebuffer,T)}else if(k){y.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(e.bindFramebuffer(a.FRAMEBUFFER,y.__webglFramebuffer[$]),y.__webglDepthbuffer[$]===void 0)y.__webglDepthbuffer[$]=a.createRenderbuffer(),mt(y.__webglDepthbuffer[$],T,!1);else{const J=T.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,j=y.__webglDepthbuffer[$];a.bindRenderbuffer(a.RENDERBUFFER,j),a.framebufferRenderbuffer(a.FRAMEBUFFER,J,a.RENDERBUFFER,j)}}else if(e.bindFramebuffer(a.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=a.createRenderbuffer(),mt(y.__webglDepthbuffer,T,!1);else{const $=T.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,J=y.__webglDepthbuffer;a.bindRenderbuffer(a.RENDERBUFFER,J),a.framebufferRenderbuffer(a.FRAMEBUFFER,$,a.RENDERBUFFER,J)}e.bindFramebuffer(a.FRAMEBUFFER,null)}function Pt(T,y,k){const $=n.get(T);y!==void 0&&Q($.__webglFramebuffer,T,T.texture,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,0),k!==void 0&&Et(T)}function Bt(T){const y=T.texture,k=n.get(T),$=n.get(y);T.addEventListener("dispose",A);const J=T.textures,j=T.isWebGLCubeRenderTarget===!0,St=J.length>1;if(St||($.__webglTexture===void 0&&($.__webglTexture=a.createTexture()),$.__version=y.version,r.memory.textures++),j){k.__webglFramebuffer=[];for(let at=0;at<6;at++)if(y.mipmaps&&y.mipmaps.length>0){k.__webglFramebuffer[at]=[];for(let ht=0;ht<y.mipmaps.length;ht++)k.__webglFramebuffer[at][ht]=a.createFramebuffer()}else k.__webglFramebuffer[at]=a.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){k.__webglFramebuffer=[];for(let at=0;at<y.mipmaps.length;at++)k.__webglFramebuffer[at]=a.createFramebuffer()}else k.__webglFramebuffer=a.createFramebuffer();if(St)for(let at=0,ht=J.length;at<ht;at++){const Lt=n.get(J[at]);Lt.__webglTexture===void 0&&(Lt.__webglTexture=a.createTexture(),r.memory.textures++)}if(T.samples>0&&yt(T)===!1){k.__webglMultisampledFramebuffer=a.createFramebuffer(),k.__webglColorRenderbuffer=[],e.bindFramebuffer(a.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let at=0;at<J.length;at++){const ht=J[at];k.__webglColorRenderbuffer[at]=a.createRenderbuffer(),a.bindRenderbuffer(a.RENDERBUFFER,k.__webglColorRenderbuffer[at]);const Lt=s.convert(ht.format,ht.colorSpace),tt=s.convert(ht.type),lt=M(ht.internalFormat,Lt,tt,ht.colorSpace,T.isXRRenderTarget===!0),kt=Kt(T);a.renderbufferStorageMultisample(a.RENDERBUFFER,kt,lt,T.width,T.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+at,a.RENDERBUFFER,k.__webglColorRenderbuffer[at])}a.bindRenderbuffer(a.RENDERBUFFER,null),T.depthBuffer&&(k.__webglDepthRenderbuffer=a.createRenderbuffer(),mt(k.__webglDepthRenderbuffer,T,!0)),e.bindFramebuffer(a.FRAMEBUFFER,null)}}if(j){e.bindTexture(a.TEXTURE_CUBE_MAP,$.__webglTexture),_t(a.TEXTURE_CUBE_MAP,y);for(let at=0;at<6;at++)if(y.mipmaps&&y.mipmaps.length>0)for(let ht=0;ht<y.mipmaps.length;ht++)Q(k.__webglFramebuffer[at][ht],T,y,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+at,ht);else Q(k.__webglFramebuffer[at],T,y,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(y)&&m(a.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(St){for(let at=0,ht=J.length;at<ht;at++){const Lt=J[at],tt=n.get(Lt);e.bindTexture(a.TEXTURE_2D,tt.__webglTexture),_t(a.TEXTURE_2D,Lt),Q(k.__webglFramebuffer,T,Lt,a.COLOR_ATTACHMENT0+at,a.TEXTURE_2D,0),p(Lt)&&m(a.TEXTURE_2D)}e.unbindTexture()}else{let at=a.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(at=T.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),e.bindTexture(at,$.__webglTexture),_t(at,y),y.mipmaps&&y.mipmaps.length>0)for(let ht=0;ht<y.mipmaps.length;ht++)Q(k.__webglFramebuffer[ht],T,y,a.COLOR_ATTACHMENT0,at,ht);else Q(k.__webglFramebuffer,T,y,a.COLOR_ATTACHMENT0,at,0);p(y)&&m(at),e.unbindTexture()}T.depthBuffer&&Et(T)}function Qt(T){const y=T.textures;for(let k=0,$=y.length;k<$;k++){const J=y[k];if(p(J)){const j=T.isWebGLCubeRenderTarget?a.TEXTURE_CUBE_MAP:a.TEXTURE_2D,St=n.get(J).__webglTexture;e.bindTexture(j,St),m(j),e.unbindTexture()}}}const P=[],ne=[];function Yt(T){if(T.samples>0){if(yt(T)===!1){const y=T.textures,k=T.width,$=T.height;let J=a.COLOR_BUFFER_BIT;const j=T.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,St=n.get(T),at=y.length>1;if(at)for(let ht=0;ht<y.length;ht++)e.bindFramebuffer(a.FRAMEBUFFER,St.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+ht,a.RENDERBUFFER,null),e.bindFramebuffer(a.FRAMEBUFFER,St.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+ht,a.TEXTURE_2D,null,0);e.bindFramebuffer(a.READ_FRAMEBUFFER,St.__webglMultisampledFramebuffer),e.bindFramebuffer(a.DRAW_FRAMEBUFFER,St.__webglFramebuffer);for(let ht=0;ht<y.length;ht++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(J|=a.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(J|=a.STENCIL_BUFFER_BIT)),at){a.framebufferRenderbuffer(a.READ_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.RENDERBUFFER,St.__webglColorRenderbuffer[ht]);const Lt=n.get(y[ht]).__webglTexture;a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,Lt,0)}a.blitFramebuffer(0,0,k,$,0,0,k,$,J,a.NEAREST),l===!0&&(P.length=0,ne.length=0,P.push(a.COLOR_ATTACHMENT0+ht),T.depthBuffer&&T.resolveDepthBuffer===!1&&(P.push(j),ne.push(j),a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,ne)),a.invalidateFramebuffer(a.READ_FRAMEBUFFER,P))}if(e.bindFramebuffer(a.READ_FRAMEBUFFER,null),e.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),at)for(let ht=0;ht<y.length;ht++){e.bindFramebuffer(a.FRAMEBUFFER,St.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+ht,a.RENDERBUFFER,St.__webglColorRenderbuffer[ht]);const Lt=n.get(y[ht]).__webglTexture;e.bindFramebuffer(a.FRAMEBUFFER,St.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+ht,a.TEXTURE_2D,Lt,0)}e.bindFramebuffer(a.DRAW_FRAMEBUFFER,St.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const y=T.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,[y])}}}function Kt(T){return Math.min(i.maxSamples,T.samples)}function yt(T){const y=n.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function ie(T){const y=r.render.frame;h.get(T)!==y&&(h.set(T,y),T.update())}function At(T,y){const k=T.colorSpace,$=T.format,J=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||k!==Tn&&k!==Mn&&(Xt.getTransfer(k)===Zt?($!==Xe||J!==un)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",k)),y}function Rt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=D,this.setTexture2D=X,this.setTexture2DArray=K,this.setTexture3D=W,this.setTextureCube=Z,this.rebindTextures=Pt,this.setupRenderTarget=Bt,this.updateRenderTargetMipmap=Qt,this.updateMultisampleRenderTarget=Yt,this.setupDepthRenderbuffer=Et,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=yt}function Lp(a,t){function e(n,i=Mn){let s;const r=Xt.getTransfer(i);if(n===un)return a.UNSIGNED_BYTE;if(n===pr)return a.UNSIGNED_SHORT_4_4_4_4;if(n===mr)return a.UNSIGNED_SHORT_5_5_5_1;if(n===Ko)return a.UNSIGNED_INT_5_9_9_9_REV;if(n===Yo)return a.BYTE;if(n===$o)return a.SHORT;if(n===ki)return a.UNSIGNED_SHORT;if(n===fr)return a.INT;if(n===Gn)return a.UNSIGNED_INT;if(n===on)return a.FLOAT;if(n===zi)return a.HALF_FLOAT;if(n===jo)return a.ALPHA;if(n===Zo)return a.RGB;if(n===Xe)return a.RGBA;if(n===Jo)return a.LUMINANCE;if(n===Qo)return a.LUMINANCE_ALPHA;if(n===vi)return a.DEPTH_COMPONENT;if(n===Ei)return a.DEPTH_STENCIL;if(n===tl)return a.RED;if(n===gr)return a.RED_INTEGER;if(n===el)return a.RG;if(n===_r)return a.RG_INTEGER;if(n===xr)return a.RGBA_INTEGER;if(n===ys||n===Ss||n===Ms||n===bs)if(r===Zt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ys)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ss)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ms)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ys)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ss)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ms)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Fa||n===Ba||n===Oa||n===ka)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Fa)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ba)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Oa)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ka)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===za||n===Ha||n===Ga)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===za||n===Ha)return r===Zt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ga)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Va||n===Wa||n===qa||n===Xa||n===Ya||n===$a||n===Ka||n===ja||n===Za||n===Ja||n===Qa||n===tr||n===er||n===nr)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Va)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Wa)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===qa)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Xa)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ya)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===$a)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ka)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ja)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Za)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ja)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Qa)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===tr)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===er)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===nr)return r===Zt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Es||n===ir||n===sr)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===Es)return r===Zt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ir)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===sr)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===nl||n===ar||n===rr||n===or)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===Es)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ar)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===rr)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===or)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===bi?a.UNSIGNED_INT_24_8:a[n]!==void 0?a[n]:null}return{convert:e}}class Ip extends Fe{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class ms extends be{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Np={type:"move"};class va{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ms,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ms,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new U,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new U),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ms,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new U,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new U),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,s=null,r=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){r=!0;for(const _ of t.hand.values()){const p=e.getJointPose(_,n),m=this._getHandJoint(c,_);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;c.inputState.pinching&&d>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(o.matrix.fromArray(i.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,i.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(i.linearVelocity)):o.hasLinearVelocity=!1,i.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(i.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Np)))}return o!==null&&(o.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=r!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new ms;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Up=`
void main() {
...
y[n] = ${n.b0.toFixed(3)}x[n] + ${n.b1.toFixed(3)}x[n−1] + ${n.b2.toFixed(3)}x[n−2] − (${n.a1.toFixed(3)})y[n−1] − (${n.a2.toFixed(3)})y[n−2]`}}biquadCoeffs(t,e,n){const i=2*Math.PI*e/n,s=Math.sin(i)/(2*Math.SQRT1_2),r=Math.cos(i);let o,l,c;t==="lowpass"?(o=(1-r)/2,l=1-r,c=(1-r)/2):(o=(1+r)/2,l=-(1+r),c=(1+r)/2);const h=1+s,u=-2*r,d=1-s;return{b0:o/h,b1:l/h,b2:c/h,a1:u/h,a2:d/h}}synthTestSignal(t){const e=t/this.synthSampleRate,n=Math.sin(2*Math.PI*220*e),i=Math.sin(2*Math.PI*2200*e);return .5*n+.35*i}stepSynthSample(){const t=this.synthN++,e=this.synthTestSignal(t);let n;if(this.preset==="tremolo")n=e*Math.cos(2*Math.PI*this.tremoloRateHz*t/this.synthSampleRate);else if(this.preset==="delay"){const i=Math.min(this.synthDelayBuffer.length-1,Math.max(1,Math.round(this.delayTimeMs/1e3*this.synthSampleRate))),s=this.synthDelayBuffer,r=(this.synthDelayWriteIdx-i+s.length)%s.length,o=s[r],l=e+this.delayFeedback*o;s[this.synthDelayWriteIdx]=l,this.synthDelayWriteIdx=(this.synthDelayWriteIdx+1)%s.length,n=e+this.delayWetMix*o}else{const i=this.preset==="lowpass"?this.lowpassCutoffHz:this.highpassCutoffHz,s=Math.min(i,this.synthSampleRate*.45),r=this.biquadCoeffs(this.preset,s,this.synthSampleRate),o=this.synthState;n=r.b0*e+r.b1*o.x1+r.b2*o.x2-r.a1*o.y1-r.a2*o.y2,o.x2=o.x1,o.x1=e,o.y2=o.y1,o.y1=n}this.synthTrail.push({x:e,y:n}),this.synthTrail.length>this.synthTrailMax&&this.synthTrail.shift()}async loadDefaultAudio(){var e;const t=cn("audio")??"audio/Linux.wav";try{this.audioCtx||(this.audioCtx=await this.sharedAudio.getContext());const i=await(await fetch(qn(t))).arrayBuffer();this.originalBuffer=await this.sharedAudio.decodeAudioData(i),this.sampleRate=this.originalBuffer.sampleRate,this.cacheStaticSpectrum(),(e=this.waveformTimeline)==null||e.setWaveformFromBuffer(this.originalBuffer),this.statusEl.textContent=`${t.split("/").pop()} · ${this.originalBuffer.duration.toFixed(1)}s`}catch{this.statusEl.textContent="Upload audio to audition"}}async handleUpload(t){var e;this.audioCtx||(this.audioCtx=await this.sharedAudio.getContext()),this.originalBuffer=await this.sharedAudio.decodeAudioData(await t.arrayBuffer()),this.sampleRate=this.originalBuffer.sampleRate,this.cacheStaticSpectrum(),(e=this.waveformTimeline)==null||e.setWaveformFromBuffer(this.originalBuffer),this.statusEl.textContent=`${t.name} · ${this.originalBuffer.duration.toFixed(1)}s`}cacheStaticSpectrum(){if(!this.originalBuffer)return;const t=this.originalBuffer.getChannelData(0),e=4096,n=Math.floor(t.length/2);this.origSpectrumStatic=this.fftMag(t.slice(n,n+e),e)}applyLiveParams(){var t,e;if(this.preset==="tremolo"){(t=this.dspNode)==null||t.port.postMessage({type:"setMode",mode:"amplitude-mod"}),(e=this.dspNode)==null||e.port.postMessage({type:"setModulation",frequency:this.tremoloRateHz});return}if(this.preset==="delay"){this.delayNode&&this.audioCtx&&this.delayNode.delayTime.setTargetAtTime(this.delayTimeMs/1e3,this.audioCtx.currentTime,.01),this.delayFeedbackGain&&(this.delayFeedbackGain.gain.value=this.delayFeedback);return}if(this.biquadNode&&this.audioCtx){this.biquadNode.type=this.preset==="lowpass"?"lowpass":"highpass";const n=this.preset==="lowpass"?this.lowpassCutoffHz:this.highpassCutoffHz;this.biquadNode.frequency.setValueAtTime(n,this.audioCtx.currentTime),this.biquadNode.Q.value=Math.SQRT1_2}}async startPlayback(t){var e;if(this.stopAudio(!1),!this.originalBuffer||!this.audioCtx){this.statusEl.textContent="Upload audio first";return}this.playMode=t,this.analyserNode=this.audioCtx.createAnalyser(),this.analyserNode.fftSize=4096,this.analyserFreqData=new Float32Array(this.analyserNode.frequencyBinCount),this.postTimeData=new Float32Array(this.analyserNode.fftSize),this.preAnalyserNode=this.audioCtx.createAnalyser(),this.preAnalyserNode.fftSize=4096,this.preTimeData=new Float32Array(this.preAnalyserNode.fftSize),this.preSilentGain=this.audioCtx.createGain(),this.preSilentGain.gain.value=0,this.gainNode=this.audioCtx.createGain(),this.gainNode.gain.value=.85,this.sourceNode=this.audioCtx.createBufferSource(),this.sourceNode.buffer=this.originalBuffer,this.sourceNode.loop=this.loop,this.sourceNode.connect(this.preAnalyserNode),this.preAnalyserNode.connect(this.preSilentGain),this.preSilentGain.connect(this.audioCtx.destination),t==="original"?(this.sourceNode.connect(this.analyserNode),this.analyserNode.connect(this.gainNode),this.gainNode.connect(this.audioCtx.destination)):(this.preset==="tremolo"?(this.dspNode=await this.sharedAudio.createDspNode({numberOfInputs:1,numberOfOutputs:1,outputChannelCount:[1]}),this.sourceNode.connect(this.dspNode),this.dspNode.connect(this.analyserNode)):this.preset==="delay"?(this.delayNode=this.audioCtx.createDelay(2),this.delayFeedbackGain=this.audioCtx.createGain(),this.delayWetGain=this.audioCtx.createGain(),this.delayWetGain.gain.value=this.delayWetMix,this.delayDryGain=this.audioCtx.createGain(),this.delayDryGain.gain.value=1,this.sourceNode.connect(this.delayDryGain),this.delayDryGain.connect(this.analyserNode),this.sourceNode.connect(this.delayNode),this.delayNode.connect(this.delayWetGain),this.delayWetGain.connect(this.analyserNode),this.delayNode.connect(this.delayFeedbackGain),this.delayFeedbackGain.connect(this.delayNode)):(this.biquadNode=this.audioCtx.createBiquadFilter(),this.sourceNode.connect(this.biquadNode),this.biquadNode.connect(this.analyserNode)),this.applyLiveParams(),this.analyserNode.connect(this.gainNode),this.gainNode.connect(this.audioCtx.destination)),this.playbackStartedAt=this.audioCtx.currentTime-this.pausedAt,this.sourceNode.start(0,this.pausedAt),this.isPlaying=!0,(e=this.transportBar)==null||e.setPlaying(!0)}pauseAudio(){var t,e;!this.isPlaying||!this.audioCtx||(this.pausedAt=this.audioCtx.currentTime-this.playbackStartedAt,this.teardownNodes(),this.isPlaying=!1,(t=this.transportBar)==null||t.setPlaying(!1),(e=this.waveformTimeline)==null||e.setPlayhead(this.pausedAt))}stopAudio(t){var e,n;this.teardownNodes(),this.isPlaying=!1,t&&(this.pausedAt=0),(e=this.transportBar)==null||e.setPlaying(!1),(n=this.waveformTimeline)==null||n.setPlayhead(this.pausedAt)}teardownNodes(){var t,e,n,i,s,r,o,l,c,h,u,d;try{(t=this.sourceNode)==null||t.stop()}catch{}(e=this.sourceNode)==null||e.disconnect(),(n=this.dspNode)==null||n.disconnect(),(i=this.biquadNode)==null||i.disconnect(),(s=this.delayNode)==null||s.disconnect(),(r=this.delayFeedbackGain)==null||r.disconnect(),(o=this.delayWetGain)==null||o.disconnect(),(l=this.delayDryGain)==null||l.disconnect(),(c=this.analyserNode)==null||c.disconnect(),(h=this.gainNode)==null||h.disconnect(),(u=this.preAnalyserNode)==null||u.disconnect(),(d=this.preSilentGain)==null||d.disconnect(),this.sourceNode=null,this.dspNode=null,this.biquadNode=null,this.delayNode=null,this.delayFeedbackGain=null,this.delayWetGain=null,this.delayDryGain=null,this.analyserNode=null,this.gainNode=null,this.preAnalyserNode=null,this.preSilentGain=null}seek(t){this.originalBuffer&&(this.pausedAt=Math.max(0,Math.min(this.originalBuffer.duration,t)),this.isPlaying&&(this.stopAudio(!1),this.startPlayback(this.playMode)))}drawXYPlot(){const t=this.xyCanvas,e=t.getContext("2d"),n=window.devicePixelRatio||1,i=t.width/n,s=t.height/n,r=24,o=i-r*2,l=s-r*2,c=r+o/2,h=r+l/2;e.fillStyle="rgba(4,5,10,0.16)",e.fillRect(0,0,i,s),e.strokeStyle="rgba(255,255,255,0.12)",e.lineWidth=1,e.strokeRect(r,r,o,l),e.beginPath(),e.moveTo(r,h),e.lineTo(r+o,h),e.moveTo(c,r),e.lineTo(c,r+l),e.strokeStyle="rgba(255,255,255,0.08)",e.stroke();const u=this.synthTrail,d=u.length;for(let f=0;f<d;f++){const{x:g,y:_}=u[f],p=c+Math.max(-1,Math.min(1,g))*(o/2),m=h-Math.max(-1,Math.min(1,_))*(l/2),M=f/d;e.fillStyle=`rgba(82,207,254,${(.12+M*.75).toFixed(2)})`,e.fillRect(p-1,m-1,2,2)}e.fillStyle="rgba(255,255,255,0.3)",e.font="8px JetBrains Mono",e.textAlign="center",e.fillText("x[n]",r+o/2,s-6),e.save(),e.translate(9,r+l/2),e.rotate(-Math.PI/2),e.fillText("y[n]",0,0),e.restore(),e.textAlign="right",e.fillStyle="rgba(120,220,140,0.75)",e.fillText(`t = ${(this.synthN/this.synthSampleRate).toFixed(1)}s`,i-6,10)}drawScope(){const t=this.scopeCanvas,e=t.getContext("2d"),n=window.devicePixelRatio||1,i=t.width/n,s=t.height/n;e.fillStyle="#04050a",e.fillRect(0,0,i,s);const r=s/2;if(e.strokeStyle="rgba(255,255,255,0.08)",e.beginPath(),e.moveTo(0,r),e.lineTo(i,r),e.stroke(),!this.preAnalyserNode||!this.analyserNode||!this.preTimeData||!this.postTimeData){e.fillStyle="rgba(255,255,255,0.3)",e.font="10px JetBrains Mono",e.textAlign="center",e.fillText("Play audio to see the scope",i/2,r);return}this.preAnalyserNode.getFloatTimeDomainData(this.preTimeData),this.analyserNode.getFloatTimeDomainData(this.postTimeData);const o=(l,c,h,u)=>{const d=l.length,f=Math.max(1,Math.floor(d/i));e.beginPath(),e.lineWidth=u,e.strokeStyle=`rgba(${c},${h})`;let g=!0;for(let _=0;_<d;_+=f){const p=_/d*i,m=r-l[_]*(s*.42);g?(e.moveTo(p,m),g=!1):e.lineTo(p,m)}e.stroke()};o(this.preTimeData,"170,180,195",.55,1.25),o(this.postTimeData,"82,207,254",.9,1.5),e.font="8px JetBrains Mono",e.textAlign="left",e.fillStyle="rgba(220,224,232,0.85)",e.fillText("before",8,12),e.fillStyle="rgba(82,207,254,0.9)",e.fillText("after",8,24)}drawSpectrumLinear(){const t=this.spectrumCanvas,e=t.getContext("2d"),n=window.devicePixelRatio||1,i=t.width/n,s=t.height/n,r={l:40,r:12,t:20,b:18},o=i-r.l-r.r,l=s-r.t-r.b;e.fillStyle="#04050a",e.fillRect(0,0,i,s);const c=(u,d,f,g)=>{let _=1e-9;const p=u.length;for(let m=0;m<p;m++){const M=d?Math.pow(10,u[m]/20):u[m];_=Math.max(_,M)}e.beginPath(),e.moveTo(r.l,r.t+l);for(let m=1;m<p;m++){const M=d?Math.pow(10,u[m]/20):u[m],v=r.l+m/(p-1)*o,S=r.t+l-M/_*l;e.lineTo(v,S)}e.lineTo(r.l+o,r.t+l),e.closePath(),e.fillStyle=`rgba(${f},${g})`,e.fill()};this.origSpectrumStatic&&c(this.origSpectrumStatic,!1,"180,180,180",.25),this.analyserNode&&this.analyserFreqData&&(this.analyserNode.getFloatFrequencyData(this.analyserFreqData),c(this.analyserFreqData,!0,"82,207,254",.65)),e.fillStyle="rgba(255,255,255,0.25)",e.font="8px JetBrains Mono",e.textAlign="center";const h=this.sampleRate/2;[0,.25,.5,.75,1].forEach(u=>{const d=u*h;e.fillText(d>=1e3?`${(d/1e3).toFixed(1)}k`:`${d.toFixed(0)}`,r.l+u*o,s-4)})}fftMag(t,e){const n=new Float64Array(e),i=new Float64Array(e);for(let l=0;l<e&&l<t.length;l++){const c=.5*(1-Math.cos(2*Math.PI*l/(e-1)));n[l]=t[l]*c}const s=e;let r=0;for(let l=1;l<s;l++){let c=s>>1;for(;r&c;c>>=1)r^=c;r^=c,l<r&&([n[l],n[r]]=[n[r],n[l]],[i[l],i[r]]=[i[r],i[l]])}for(let l=2;l<=s;l<<=1){const c=Math.cos(-2*Math.PI/l),h=Math.sin(-2*Math.PI/l);for(let u=0;u<s;u+=l){let d=1,f=0;for(let g=0;g<l/2;g++){const _=n[u+g],p=i[u+g],m=n[u+g+l/2]*d-i[u+g+l/2]*f,M=n[u+g+l/2]*f+i[u+g+l/2]*d;n[u+g]=_+m,i[u+g]=p+M,n[u+g+l/2]=_-m,i[u+g+l/2]=p-M;const v=d*c-f*h;f=d*h+f*c,d=v}}}const o=new Float32Array(e/2);for(let l=0;l<e/2;l++)o[l]=Math.sqrt(n[l]*n[l]+i[l]*i[l])/e;return o}startAnimation(){const t=e=>{var s;this.synthLastFrameMs===null&&(this.synthLastFrameMs=e);const n=Math.min(250,e-this.synthLastFrameMs);this.synthLastFrameMs=e;const i=Math.max(1,Math.round(n/1e3*this.synthSampleRate));for(let r=0;r<i;r++)this.stepSynthSample();this.isPlaying&&this.audioCtx&&this.originalBuffer&&(this.pausedAt=Math.min(this.audioCtx.currentTime-this.playbackStartedAt,this.originalBuffer.duration),(s=this.waveformTimeline)==null||s.setPlayhead(this.pausedAt)),this.drawXYPlot(),this.drawScope(),this.drawSpectrumLinear(),this.animId=requestAnimationFrame(t)};this.animId=requestAnimationFrame(t)}destroy(){this.animId!==null&&cancelAnimationFrame(this.animId),this.stopAudio(!0),window.removeEventListener("resize",this.onResize),document.body.style.overflowY=""}}function Em(a,t,e=5){const n=new Float64Array(t),i=t-1;for(let s=0;s<t;s++)if(a==="rectangular")n[s]=1;else if(a==="hann")n[s]=.5*(1-Math.cos(2*Math.PI*s/i));else if(a==="hamming")n[s]=.54-.46*Math.cos(2*Math.PI*s/i);else if(a==="blackman")n[s]=.42-.5*Math.cos(2*Math.PI*s/i)+.08*Math.cos(4*Math.PI*s/i);else{const r=2*s/i-1;n[s]=zo(e*Math.sqrt(Math.max(0,1-r*r)))/zo(e)}return n}function zo(a){let t=1,e=1;for(let n=1;n<24&&(e*=a*a/(4*n*n),t+=e,!(e<1e-12));n++);return t}function wm(a){return a>50?.1102*(a-8.7):a>=21?.5842*Math.pow(a-21,.4)+.07886*(a-21):0}function Tm(a){const t=Math.max(1,a.fstop-a.fp),e=Math.ceil((a.asDb-7.95)/(2.285*(2*Math.PI*t/a.fs))),n=Math.ceil(a.asDb*a.fs/(22*t)),i=Math.max(e,n,15);return i%2===0?i+1:i}function Am(a,t){const e=Tm(a),n=(a.fp+a.fstop)/2,i=t==="kaiser"?wm(a.asDb):5,s=Em(t,e,i),r=new Array(e),o=(e-1)/2,l=2*Math.PI*n/a.fs;for(let h=0;h<e;h++){const u=h-o,d=u===0?l/Math.PI:Math.sin(l*u)/(Math.PI*u);r[h]=d*s[h]}const c=r.reduce((h,u)=>h+u,0);if(Math.abs(c)>1e-12)for(let h=0;h<r.length;h++)r[h]/=c;return{b:r,a:[1],order:e-1,methodLabel:`FIR · window ${t}`,window:t}}function Ho(a,t){const e=new Array(a.length+t.length-1).fill(0);for(let n=0;n<a.length;n++)for(let i=0;i<t.length;i++)e[n+i]+=a[n]*t[i];return e}function Cm(a,t){const e=2*t+1;return 1/(2*Math.cos(Math.PI*e/(2*a)))}function Pm(a,t,e){const n=2*Math.PI*a/e,i=Math.cos(n),r=Math.sin(n)/(2*t),o=1+r;return{b:[(1-i)/2/o,(1-i)/o,(1-i)/2/o],a:[1,-2*i/o,(1-r)/o]}}function wa(a,t,e,n){const i=Math.max(1,Math.ceil(a/2));let s=[1],r=[1];for(let l=0;l<i;l++){const c=Cm(a,l),{b:h,a:u}=Pm(n,c,t.fs);s=Ho(s,h),r=Ho(r,u)}const o=s.reduce((l,c)=>l+c,0)/r.reduce((l,c)=>l+c,0);return s=s.map(l=>l/o),{b:s,a:r,order:a,methodLabel:e}}function Rm(a,t){const e=2*Math.PI*a.fp/a.fs,i=2*Math.PI*a.fstop/a.fs/e;if(t==="butterworth"){const s=Math.ceil(Math.log10((Math.pow(10,a.asDb/10)-1)/(Math.pow(10,a.apDb/10)-1))/(2*Math.log10(i)));return Math.max(2,Math.min(12,s))}return Math.max(2,Math.min(10,Math.ceil(a.asDb/10)))}function Ta(a,t){const e=Rm(a,t),n=a.apDb,i=t==="chebyshev2"?a.fstop*.98:a.fp*1.02;return t==="butterworth"?wa(e,a,`IIR · Butterworth (order ${e})`,i):t==="chebyshev1"?wa(e,a,`IIR · Chebyshev I (order ${e}, ripple ${n.toFixed(3)} dB)`,i):wa(e,a,`IIR · Chebyshev II (order ${e})`,i)}function Dm(a,t,e="hamming"){return a==="fir-window"?Am(t,e):a==="iir-butterworth"?Ta(t,"butterworth"):a==="iir-chebyshev1"?Ta(t,"chebyshev1"):Ta(t,"chebyshev2")}function Lm(a,t,e,n){const i=new Float32Array(e),s=new Float32Array(e),r=new Float32Array(e),o=n/2;for(let l=0;l<e;l++){const c=l/(e-1)*o;i[l]=c;const h=2*Math.PI*c/n,{re:u,im:d}=Im(h,a,t),f=Math.sqrt(u*u+d*d);s[l]=20*Math.log10(Math.max(f,1e-12)),r[l]=Math.atan2(d,u)}return{freqs:i,magDb:s,phase:r}}function Im(a,t,e){const n=o=>{let l=0,c=0;for(let h=0;h<o.length;h++){const u=-a*h;l+=o[h]*Math.cos(u),c+=o[h]*Math.sin(u)}return{re:l,im:c}},i=n(t),s=n(e),r=s.re*s.re+s.im*s.im;return r<1e-20?{re:1,im:0}:{re:(i.re*s.re+i.im*s.im)/r,im:(i.im*s.re-i.re*s.im)/r}}function Nm(a,t,e,n,i){const s=document.createElement("label");s.style.cssText="display:flex;flex-direction:column;gap:2px;font-size:9px;color:rgba(255,255,255,0.45);min-width:90px;",s.textContent=a;const r=document.createElement("div");r.style.display="flex",r.style.gap="4px",r.style.alignItems="center";const o=document.createElement("input");o.type="number",o.id=t,o.value=String(e),o.disabled=!i,o.style.cssText="width:88px;font:11px JetBrains Mono,monospace;background:#0c1018;color:#e8eef8;border:1px solid #253040;border-radius:4px;padding:4px 6px;";const l=document.createElement("span");return l.textContent=n,l.style.fontSize="9px",r.append(o,l),s.appendChild(r),s}class Um{constructor(t){x(this,"container");x(this,"animId",null);x(this,"sharedAudio",Ze.getInstance());x(this,"audioCtx",null);x(this,"originalBuffer",null);x(this,"sourceNode",null);x(this,"dspNode",null);x(this,"gainNode",null);x(this,"analyserNode",null);x(this,"analyserData",null);x(this,"origSpectrumStatic",null);x(this,"sampleRate",1e4);x(this,"isPlaying",!1);x(this,"playMode","filtered");x(this,"playbackStartedAt",0);x(this,"pausedAt",0);x(this,"loop",!1);x(this,"filterB",[1]);x(this,"filterA",[1]);x(this,"magDb",new Float32Array(512));x(this,"method","fir-window");x(this,"windowType","hamming");x(this,"transportBar");x(this,"waveformTimeline");x(this,"statusEl");x(this,"infoEl");x(this,"responseCanvas");x(this,"spectrumCanvas");x(this,"inputs",{});x(this,"methodSelect");x(this,"windowSelect");x(this,"onResize",()=>this.resizeLayout());const e=document.getElementById(t);if(!e)throw new Error(`Container "${t}" not found`);this.container=e,this.buildUI(),this.redesign(),window.addEventListener("resize",this.onResize),this.resizeLayout(),this.startAnimation(),this.loadDefaultAudio()}buildUI(){if(document.body.style.overflowY="auto",gt("transport",!0)){this.transportBar=new Yn({onPlay:()=>void this.startPlayback(this.playMode),onPause:()=>this.pauseAudio(),onStop:()=>this.stopAudio(!0),onUpload:h=>void this.handleUpload(h),uploadLabel:"Upload Audio",showUpload:gt("upload",!0),onLoopToggle:h=>{this.loop=h,this.sourceNode&&(this.sourceNode.loop=h)}}),this.statusEl=document.createElement("span"),this.statusEl.className="transport-status",this.statusEl.textContent="ECG exercise: upload ECG.wav or use default",this.transportBar.getElement().querySelector(".transport-left").appendChild(this.statusEl);const c=document.createElement("div");c.style.cssText="display:flex;gap:4px;margin-left:8px;",["original","filtered"].forEach(h=>{const u=document.createElement("button");u.className="transport-mode-btn"+(h===this.playMode?" active":""),u.textContent=h==="original"?"Original":"Filtered",u.style.fontSize="9px",u.addEventListener("click",()=>{this.playMode=h,c.querySelectorAll(".transport-mode-btn").forEach(d=>d.classList.toggle("active",d===u)),this.isPlaying&&(this.stopAudio(!1),this.startPlayback(h))}),c.appendChild(u)}),this.transportBar.getElement().querySelector(".transport-left").appendChild(c),this.container.appendChild(this.transportBar.getElement())}else this.statusEl=document.createElement("span"),this.statusEl.style.display="none",this.container.appendChild(this.statusEl);gt("waveform",!0)&&(this.waveformTimeline=new Xn({width:900,height:64,title:"WAVEFORM"},c=>this.seek(c)),this.container.appendChild(this.waveformTimeline.getElement()));const t=this.makePanel("FILTER SPECIFICATION"),e=document.createElement("div");e.style.cssText="display:flex;flex-wrap:wrap;gap:10px;padding:26px 10px 10px;";const n={fs:Ai("Fs",1e4),fp:Ai("fp",1250),fstop:Ai("fs",3500),asDb:Ai("As",45),apDb:Ai("Ap",.077)},i=[{key:"fs",label:"Fs",unit:"Hz",q:"Fs"},{key:"fp",label:"fp",unit:"Hz",q:"fp"},{key:"fstop",label:"fs (stop)",unit:"Hz",q:"fs"},{key:"asDb",label:"As",unit:"dB",q:"As"},{key:"apDb",label:"Ap",unit:"dB",q:"Ap"}];for(const c of i){const h=gt(c.q,!0),u=Nm(c.label,c.key,n[c.key],c.unit,h),d=u.querySelector("input");this.inputs[c.key]=d,d.addEventListener("change",()=>this.redesign()),e.appendChild(u)}const s=document.createElement("label");s.style.cssText="display:flex;flex-direction:column;gap:2px;font-size:9px;color:rgba(255,255,255,0.45);min-width:180px;",s.textContent="Design method",this.methodSelect=document.createElement("select"),this.methodSelect.disabled=!gt("method",!0),this.methodSelect.style.cssText="font:11px JetBrains Mono,monospace;background:#0c1018;color:#e8eef8;border:1px solid #253040;border-radius:4px;padding:4px;",[["fir-window","FIR · window method"],["iir-butterworth","IIR · Butterworth"],["iir-chebyshev1","IIR · Chebyshev I"],["iir-chebyshev2","IIR · Chebyshev II"]].forEach(([c,h])=>{const u=document.createElement("option");u.value=c,u.textContent=h,this.methodSelect.appendChild(u)}),this.methodSelect.addEventListener("change",()=>{this.method=this.methodSelect.value,this.windowSelect.style.display=this.method==="fir-window"?"block":"none",this.redesign()}),s.appendChild(this.methodSelect);const r=document.createElement("label");r.style.cssText="display:flex;flex-direction:column;gap:2px;font-size:9px;color:rgba(255,255,255,0.45);min-width:140px;",r.textContent="Window",this.windowSelect=document.createElement("select"),this.windowSelect.disabled=!gt("window",!0),this.windowSelect.style.cssText=this.methodSelect.style.cssText,["rectangular","hann","hamming","blackman","kaiser"].forEach(c=>{const h=document.createElement("option");h.value=c,h.textContent=c,c==="hamming"&&(h.selected=!0),this.windowSelect.appendChild(h)}),this.windowSelect.addEventListener("change",()=>{this.windowType=this.windowSelect.value,this.redesign()}),r.appendChild(this.windowSelect),e.append(s,r),t.appendChild(e),this.infoEl=document.createElement("div"),this.infoEl.style.cssText="padding:0 10px 10px;font:11px JetBrains Mono,monospace;color:#52cffe;",t.appendChild(this.infoEl),this.container.appendChild(t);const o=this.makePanel("MAGNITUDE RESPONSE · dB");this.responseCanvas=this.makeCanvas2D(o,900,120),o.style.marginBottom="6px",this.container.appendChild(o);const l=this.makePanel("SPECTRUM (linear) · gray=original · cyan=filtered");this.spectrumCanvas=this.makeCanvas2D(l,900,110),this.container.appendChild(l)}getSpecs(){return{fs:Number(this.inputs.fs.value)||1e4,fp:Number(this.inputs.fp.value)||1250,fstop:Number(this.inputs.fstop.value)||3500,asDb:Number(this.inputs.asDb.value)||45,apDb:Number(this.inputs.apDb.value)||.077}}redesign(){const t=this.getSpecs();this.sampleRate=t.fs;const e=Dm(this.method,t,this.windowType);this.filterB=e.b,this.filterA=e.a,this.infoEl.textContent=`${e.methodLabel} · order ${e.order} · ${e.b.length} taps / ${e.a.length} denom`;const n=Lm(this.filterB,this.filterA,512,t.fs);this.magDb=new Float32Array(n.magDb),this.dspNode&&this.dspNode.port.postMessage({type:"setIIR",b:this.filterB,a:this.filterA})}makePanel(t){const e=document.createElement("div");e.style.cssText="background:#080b10;border:1px solid #1e2530;border-radius:6px;overflow:hidden;position:relative;margin-bottom:6px;";const n=document.createElement("div");return n.style.cssText="position:absolute;top:4px;left:8px;font-size:7px;font-weight:700;letter-spacing:.08em;color:rgba(255,255,255,0.35);text-transform:uppercase;z-index:2;",n.textContent=t,e.appendChild(n),e}makeCanvas2D(t,e,n){const i=window.devicePixelRatio||1,s=document.createElement("canvas");return s.width=e*i,s.height=n*i,s.style.width=`${e}px`,s.style.height=`${n}px`,s.style.display="block",s.getContext("2d").scale(i,i),t.appendChild(s),s}resizeCanvas(t,e,n){const i=window.devicePixelRatio||1;t.width=e*i,t.height=n*i,t.style.width=`${e}px`,t.style.height=`${n}px`;const s=t.getContext("2d");s.setTransform(1,0,0,1,0,0),s.scale(i,i)}resizeLayout(){var e;const t=Math.max(640,this.container.clientWidth-2);(e=this.waveformTimeline)==null||e.resize(t,64),this.resizeCanvas(this.responseCanvas,t,120),this.resizeCanvas(this.spectrumCanvas,t,110)}async loadDefaultAudio(){var e;const t=cn("audio")??"audio/Linux.wav";try{this.audioCtx||(this.audioCtx=await this.sharedAudio.getContext());const i=await(await fetch(qn(t))).arrayBuffer();this.originalBuffer=await this.sharedAudio.decodeAudioData(i),this.cacheStaticSpectrum(),(e=this.waveformTimeline)==null||e.setWaveformFromBuffer(this.originalBuffer),this.statusEl.textContent=`${t.split("/").pop()} · ${this.originalBuffer.duration.toFixed(1)}s`}catch{this.statusEl.textContent="Upload ECG.wav (or any clip)"}}async handleUpload(t){var e;this.audioCtx||(this.audioCtx=await this.sharedAudio.getContext()),this.originalBuffer=await this.sharedAudio.decodeAudioData(await t.arrayBuffer()),this.cacheStaticSpectrum(),(e=this.waveformTimeline)==null||e.setWaveformFromBuffer(this.originalBuffer),this.statusEl.textContent=`${t.name} · ${this.originalBuffer.duration.toFixed(1)}s`}cacheStaticSpectrum(){if(!this.originalBuffer)return;const t=this.originalBuffer.getChannelData(0),e=4096,n=Math.floor(t.length/2);this.origSpectrumStatic=this.fftMag(t.slice(n,n+e),e)}async startPlayback(t){var e;this.stopAudio(!1),!(!this.originalBuffer||!this.audioCtx)&&(this.playMode=t,this.analyserNode=this.audioCtx.createAnalyser(),this.analyserNode.fftSize=4096,this.analyserData=new Float32Array(this.analyserNode.frequencyBinCount),this.gainNode=this.audioCtx.createGain(),this.gainNode.gain.value=.85,this.sourceNode=this.audioCtx.createBufferSource(),this.sourceNode.buffer=this.originalBuffer,this.sourceNode.loop=this.loop,t==="original"?(this.sourceNode.connect(this.analyserNode),this.analyserNode.connect(this.gainNode),this.gainNode.connect(this.audioCtx.destination)):(this.dspNode=await this.sharedAudio.createDspNode({numberOfInputs:1,numberOfOutputs:1,outputChannelCount:[1]}),this.dspNode.port.postMessage({type:"setMode",mode:"iir"}),this.dspNode.port.postMessage({type:"setIIR",b:this.filterB,a:this.filterA}),this.sourceNode.connect(this.dspNode),this.dspNode.connect(this.analyserNode),this.analyserNode.connect(this.gainNode),this.gainNode.connect(this.audioCtx.destination)),this.playbackStartedAt=this.audioCtx.currentTime-this.pausedAt,this.sourceNode.start(0,this.pausedAt),this.isPlaying=!0,(e=this.transportBar)==null||e.setPlaying(!0))}pauseAudio(){var t;!this.isPlaying||!this.audioCtx||(this.pausedAt=this.audioCtx.currentTime-this.playbackStartedAt,this.teardownNodes(),this.isPlaying=!1,(t=this.transportBar)==null||t.setPlaying(!1))}stopAudio(t){var e,n;this.teardownNodes(),this.isPlaying=!1,t&&(this.pausedAt=0),(e=this.transportBar)==null||e.setPlaying(!1),(n=this.waveformTimeline)==null||n.setPlayhead(this.pausedAt)}teardownNodes(){var t,e,n,i,s;try{(t=this.sourceNode)==null||t.stop()}catch{}(e=this.sourceNode)==null||e.disconnect(),(n=this.dspNode)==null||n.disconnect(),(i=this.analyserNode)==null||i.disconnect(),(s=this.gainNode)==null||s.disconnect(),this.sourceNode=null,this.dspNode=null,this.analyserNode=null,this.gainNode=null}seek(t){this.originalBuffer&&(this.pausedAt=Math.max(0,Math.min(this.originalBuffer.duration,t)),this.isPlaying&&(this.stopAudio(!1),this.startPlayback(this.playMode)))}drawResponse(){const t=this.responseCanvas,e=t.getContext("2d"),n=window.devicePixelRatio||1,i=t.width/n,s=t.height/n,r={l:44,r:12,t:22,b:22},o=i-r.l-r.r,l=s-r.t-r.b;e.fillStyle="#04050a",e.fillRect(0,0,i,s);const c=this.getSpecs();let h=-80,u=5;for(let _=0;_<this.magDb.length;_++)h=Math.min(h,this.magDb[_]),u=Math.max(u,this.magDb[_]);const d=(_,p,m)=>{const M=r.t+l-(_-h)/(u-h)*l;e.strokeStyle=p,e.setLineDash(m??[]),e.beginPath(),e.moveTo(r.l,M),e.lineTo(r.l+o,M),e.stroke(),e.setLineDash([])};d(-c.asDb,"rgba(255,134,154,0.55)",[4,4]),d(-c.apDb,"rgba(82,207,254,0.45)",[2,3]),e.beginPath();for(let _=0;_<this.magDb.length;_++){const p=r.l+_/(this.magDb.length-1)*o,m=r.t+l-(this.magDb[_]-h)/(u-h)*l;_===0?e.moveTo(p,m):e.lineTo(p,m)}e.strokeStyle="#ffd700",e.lineWidth=2,e.stroke();const f=r.l+c.fp/(c.fs/2)*o,g=r.l+c.fstop/(c.fs/2)*o;e.strokeStyle="rgba(82,207,254,0.35)",e.beginPath(),e.moveTo(f,r.t),e.lineTo(f,r.t+l),e.moveTo(g,r.t),e.lineTo(g,r.t+l),e.stroke()}drawSpectrum(){const t=this.spectrumCanvas,e=t.getContext("2d"),n=window.devicePixelRatio||1,i=t.width/n,s=t.height/n,r={l:40,r:12,t:18,b:18},o=i-r.l-r.r,l=s-r.t-r.b;e.fillStyle="#04050a",e.fillRect(0,0,i,s);const c=(u,d,f,g)=>{let _=1e-9;for(let p=0;p<u.length;p++){const m=d?Math.pow(10,u[p]/20):u[p];_=Math.max(_,m)}e.beginPath(),e.moveTo(r.l,r.t+l);for(let p=1;p<u.length;p++){const m=d?Math.pow(10,u[p]/20):u[p],M=r.l+p/(u.length-1)*o,v=r.t+l-m/_*l;e.lineTo(M,v)}e.closePath(),e.fillStyle=`rgba(${f},${g})`,e.fill()};this.origSpectrumStatic&&c(this.origSpectrumStatic,!1,"180,180,180",.25),this.analyserNode&&this.analyserData&&(this.analyserNode.getFloatFrequencyData(this.analyserData),c(this.analyserData,!0,"82,207,254",.65));const h=this.getSpecs().fs/2;e.fillStyle="rgba(255,255,255,0.25)",e.font="8px JetBrains Mono",e.textAlign="center",[0,.25,.5,.75,1].forEach(u=>{const d=u*h;e.fillText(d>=1e3?`${(d/1e3).toFixed(1)}k`:`${d.toFixed(0)}`,r.l+u*o,s-4)})}fftMag(t,e){const n=new Float64Array(e),i=new Float64Array(e);for(let l=0;l<e&&l<t.length;l++)n[l]=t[l];const s=e;let r=0;for(let l=1;l<s;l++){let c=s>>1;for(;r&c;c>>=1)r^=c;r^=c,l<r&&([n[l],n[r]]=[n[r],n[l]],[i[l],i[r]]=[i[r],i[l]])}for(let l=2;l<=s;l<<=1){const c=Math.cos(-2*Math.PI/l),h=Math.sin(-2*Math.PI/l);for(let u=0;u<s;u+=l){let d=1,f=0;for(let g=0;g<l/2;g++){const _=n[u+g],p=i[u+g],m=n[u+g+l/2]*d-i[u+g+l/2]*f,M=n[u+g+l/2]*f+i[u+g+l/2]*d;n[u+g]=_+m,i[u+g]=p+M,n[u+g+l/2]=_-m,i[u+g+l/2]=p-M;const v=d*c-f*h;f=d*h+f*c,d=v}}}const o=new Float32Array(e/2);for(let l=0;l<e/2;l++)o[l]=Math.sqrt(n[l]*n[l]+i[l]*i[l])/e;return o}startAnimation(){const t=()=>{var e;this.isPlaying&&this.audioCtx&&this.originalBuffer&&(this.pausedAt=Math.min(this.audioCtx.currentTime-this.playbackStartedAt,this.originalBuffer.duration),(e=this.waveformTimeline)==null||e.setPlayhead(this.pausedAt)),this.drawResponse(),this.drawSpectrum(),this.animId=requestAnimationFrame(t)};this.animId=requestAnimationFrame(t)}destroy(){this.animId!==null&&cancelAnimationFrame(this.animId),this.stopAudio(!0),window.removeEventListener("resize",this.onResize),document.body.style.overflowY=""}}class yn{constructor(t,e){x(this,"root");x(this,"content");this.root=document.createElement("div"),this.root.className="demo-shell";const n=document.createElement("div");n.className="demo-shell-toolbar";const i=document.createElement("button");i.className="back-button",i.textContent="← Back",i.onclick=e;const s=document.createElement("div");s.className="demo-shell-title",s.textContent=t,n.append(i,s),this.content=document.createElement("div"),this.content.className="demo-shell-content",this.root.append(n,this.content)}getElement(){return this.root}getContentElement(){return this.content}}function Fm(a="app"){const t=document.getElementById(a);if(!t)return()=>{};t.style.transformOrigin="center center";let e=null;const n=()=>{e=null;const r=t.offsetWidth,o=t.offsetHeight;if(r===0||o===0)return;const l=window.innerWidth,c=window.innerHeight,h=16,u=(l-h)/r,d=(c-h)/o,f=Math.max(.1,Math.min(u,d));t.style.transform=`scale(${f})`},i=()=>{e!==null&&cancelAnimationFrame(e),e=requestAnimationFrame(n)};window.addEventListener("resize",i);const s=new ResizeObserver(i);return s.observe(t),i(),()=>{window.removeEventListener("resize",i),s.disconnect(),e!==null&&cancelAnimationFrame(e)}}let It=null;document.addEventListener("DOMContentLoaded",()=>{const a=document.getElementById("app"),t=new Pl;t.register("/",()=>({mount:()=>{new Rl(a,t).mount()},unmount:()=>{a.innerHTML=""}})),t.register("/aliasing-sine",()=>({mount:()=>{a.innerHTML="";const e=new yn("Sine Wave Aliasing",()=>t.navigate("/")),n=document.createElement("div");n.id="sine-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new Dl("sine-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.register("/aliasing-audio",()=>({mount:()=>{a.innerHTML="";const e=new yn("Audio Aliasing",()=>t.navigate("/")),n=document.createElement("div");n.id="audio-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new Ca("audio-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.register("/z-transform",()=>({mount:()=>{a.innerHTML="";const e=new yn("Z-Transform Explorer",()=>t.navigate("/")),n=document.createElement("div");n.id="ztransform-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new Pa("ztransform-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.register("/pole-zero",()=>({mount:()=>{a.innerHTML="";const e=new yn("Pole-Zero Designer",()=>t.navigate("/")),n=document.createElement("div");n.id="polezero-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new cm("polezero-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.register("/convolution",()=>({mount:()=>{a.innerHTML="";const e=new yn("Convolution / Cross-Correlation",()=>t.navigate("/")),n=document.createElement("div");n.id="convolution-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new wr("convolution-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.register("/dft-demo",()=>({mount:()=>{a.innerHTML="";const e=new yn("DFT Accumulator",()=>t.navigate("/")),n=document.createElement("div");n.id="dft-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new Mm("dft-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.register("/difference-equations",()=>({mount:()=>{a.innerHTML="";const e=new yn("Difference Equations",()=>t.navigate("/")),n=document.createElement("div");n.id="diff-eq-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new bm("diff-eq-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.register("/filter-design",()=>({mount:()=>{a.innerHTML="";const e=new yn("Filter Specification & Design",()=>t.navigate("/")),n=document.createElement("div");n.id="filter-design-container",e.getContentElement().appendChild(n),a.appendChild(e.getElement()),It=new Um("filter-design-container")},unmount:()=>{It&&"destroy"in It&&It.destroy(),It=null,a.innerHTML=""}})),t.start(),Fm("app")});
