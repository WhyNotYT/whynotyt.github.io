...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function io(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ma(),fragmentShader:`
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function so(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ma(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Zf(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Uo?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Al?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===nn&&(t="SHADOWMAP_TYPE_VSM"),t}function jf(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case _i:case vi:t="ENVMAP_TYPE_CUBE";break;case Ns:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Jf(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case vi:t="ENVMAP_MODE_REFRACTION";break}return t}function Qf(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Fo:t="ENVMAP_BLENDING_MULTIPLY";break;case Jl:t="ENVMAP_BLENDING_MIX";break;case Ql:t="ENVMAP_BLENDING_ADD";break}return t}function tp(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function ep(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Zf(e),c=jf(e),h=Jf(e),u=Qf(e),d=tp(e),f=Gf(e),g=Vf(s),_=i.createProgram();let p,m,M=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Di).join(`
`)),a=ia(a),a=mo(a,e),a=go(a,e),o=ia(o),o=mo(o,e),o=go(o,e),a=_o(a),o=_o(o),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
